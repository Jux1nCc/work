var folkcam = {
    ...
    scoolPage: 0,
    map: null,
    markerArr: [{ title: "深圳市镜玩科技有限公司", content: "联系电话：0755-86523543", point: "113.959115|22.540473", isOpen: 1, icon: { w: 23, h: 25, l: 46, t: 21, x: 9, lb: 12 } }
    ],
    page: 0,
    dynamicIndex: 0,
    dynamicArr: [  //公司动态数据， 关联首页（新闻中心），镜玩动态列表，另外：动态详情需要手动写入dynamicDetail.html文件中的newDetail-wrap>detail-main中
        {
            date: '06-02',   //新闻时间
            year: '2021',     //新闻年份                                                          
            title: '兔聊App：深度洞察80、90后单身青年情感观，打造真实高效交友平台',   //新闻主题
            text: '随着时代的发展，“脱单难”成为了80、90后普遍存在的问题，更是备受关注的社会民生问题。',  //新闻介绍
            imgPath: 'img/newDetail/2021-06-01.gif'     //动态关联的图片路径
        },
        {
            date: '05-18',   //新闻时间
            year: '2021',     //新闻年份                                                          
            title: '兔聊App：打造轻松交友，绿色安全社交平台，我们是认真的！',   //新闻主题
            text: '随着互联网时代的到来，诈骗手段可谓层出不穷，花样百出。',  //新闻介绍
            imgPath: 'img/newDetail/2021-05-02.png'     //动态关联的图片路径
        },
        {
            date: '12-07',   //新闻时间
            year: '2020',     //新闻年份                                                          
            title: '纪念五载奋进路，再展镜玩新宏图',   //新闻主题
            text: '岁月如歌，征途如虹，五载弹指一挥间，深圳市镜玩科技有限公司迎来了五周年的生日。',  //新闻介绍
            imgPath: 'img/newDetail/2020-12-01.png'     //动态关联的图片路径
        },
        {
            date: '11-03',   //新闻时间
            year: '2020',     //新闻年份                                                          
            title: '“觅伊”积极响应“净网2020”号召，打造网络安全高地',   //新闻主题
            text: '为了打击整治网络违法犯罪活动，深入整顿网络秩序，进一步营造安全、清朗、有序的网络环境，公安局开展“净网2020”专项活动，活动进展至今取得显著成效',  //新闻介绍
            imgPath: 'img/newDetail/2020-11-01.jpg'     //动态关联的图片路径
        },
        {
            date: '08',   //新闻时间
            year: '2020',     //新闻年份                                                          
            title: '镜玩科技旗下产品通过网安集团合规检测',   //新闻主题
            text: '2020年8月，镜玩科技响应国家对信息服务和新技术、新应用的号召，积极拥抱中央网信办、工信部、公安部、市场监管总局等相关监管部门信息安全政策。',  //新闻介绍
            imgPath: 'img/newDetail/20200802.png'     //动态关联的图片路径
        },
        {
            date: '05-15',   //新闻时间
            year: '2020',     //新闻年份                                                          
            title: '新锐互联网投资人许飞莅临我司交流',   //新闻主题
            text: '5月15日下午14:30左右，新锐互联网投资人、中国天使会创始会员许飞莅临我司交流。',  //新闻介绍
            imgPath: 'img/20200515.png'     //动态关联的图片路径
        },
        {
            date: '03-30',
            year: '2020',
        ...
        },
        {
            date: '02-14',
            year: '2020',
            title: '2020激流勇进 镜玩科技招贤纳士集结令',
            text: '2020 "鼠"你最牛；镜玩科技开启了新一年；"携手共启征程"的年会主题；让来自五湖四海的镜玩人欢聚一堂',
            imgPath: 'img/20200214/tp6.png'
        },
        {
            date: '12-19',
            year: '2019',
        ...
        },
        {
            date: '11-21',
            year: '2019',
            title: '台湾高效男神尹志豪老师莅临我司交流',
            text: '11月21日下午15:00左右，台湾高效男神尹志豪老师和他的团队一行人莅临我司交流。我司总裁谢总接待并参与此次交流会议。',
            imgPath: 'img/20191121.jpg'
        },
        {
            date: '11-16',
            year: '2019',
        ...
        },
        {
            ...
            year: '2019',
            title: '管理大家谈启动会报道',
            text: '镜玩科技是一个非常年轻且充满活力的企业，一直以往公司对于人才的培养、人才的关注都是非常重视的。随着公司项目的发展及公司近期的规划，对于公司中层管理人员的储备与培养，日益迫切。',
            imgPath: 'img/20190823.png'
        },
        {
            date: '07-20',
            year: '2019',
            title: '团结创新，续我辉煌——镜玩科技团建活动',
            text: '2019年7月20日，为了增进员工身心健康，锻炼大家的身体素质，提高团队的凝聚力，加强员工的沟通与交流，丰富员工的业余文化生活，深圳市镜玩科技有限公司以"打造' + '赢' + '的团队"为主题，组织全体员工在深圳某拓展基地举办了为期一天的军训拓展活动。',
            imgPath: 'img/20190720/2019072005.jpg'
        },
        {
            date: '07-13',
            year: '2019',
        ...
        },
        {
            date: '04-13',
            year: '2019',
            title: '镜玩科技赴武汉大学开展校招工作',
            text: '2019年4月13日，武汉大学2019届毕业生春季校园供需见面会在武汉大学工学部体育馆举行，深圳市镜玩科技有限公司有幸参与了本次供需见面会。',
        ...
        },
        {
            ...
            text: '2019年3月25日晚7时，镜玩科技有幸邀请到了行业内的资深投资专家李立远先生在公司内部交流分享。',
            imgPath: 'img/2019032501.jpg'
        },
        {
            date: '03-15',
            year: '2019',
            title: '互联网行业大牛-谢宏中加入镜玩科技！',
            text: '2019年3月15日，谢宏中先生正式出任镜玩科技常务副总一职，该任命自2019年3月15日起生效。',
            imgPath: 'img/2019031501.png'
        },
        {
            date: '03-08',
            year: '2019',
            title: '镜玩女神们，给你不一般的宠爱！',
            text: '春风和煦，柔和悠扬，转眼就到了"3.8女神节"。我们镜玩要！搞！事！情！啦！',
        ...
        },
        {
            ...
            text: '镜玩科技春季校园招聘，寻求志同道合的合作伙伴(详情内容只展示两行）',
            imgPath: 'img/2019030601.jpg'
        },
        {
            date: '01-19',
            year: '2019',
            title: '不忘初心 砥砺前行——镜玩科技2019年新春年会新闻稿',
            text: '律回春晖渐，万象始更新。2019年1月19日晚6时，镜玩科技有限公司2019新春年会在广东河源万绿湖东方国际酒店隆重拉开帷幕。围绕“不忘初心 砥砺前行”的年会主题，镜玩科技全体成员共计60余人齐聚一堂，总结过去一年取得的辉煌业绩，谋划新一年的未来发展。',
            imgPath: 'img/20190119/boss.png'
        },
        {
            date: '11-22',
            year: '2018',
            title: '这一站，地球肺叶西双版纳——镜玩科技组织的员工旅游活动圆满结束',
            text: '2017年11月22日，镜玩科技组织的员工旅游活动又一次拉开了帷幕',
    ...
    leaderArr: [
        ...
        },
        {
            name: '赖华来',
            position: '事业部总经理',
            intro: '镜玩科技的创始人之一，公司董事。参与公司创业项目—兔聊项目从0到1全流程开发，丰富的互联网产品的规划和设计经验，带领团队经验丰富，工作扎实，富有洞察力。',
        ...
        },
        {
            name: '肖雅利',
            position: '总裁办主任',
            intro: '2017年初加入镜玩科技，担任公司总经办主任一职，公司董事，负责公司人力资源、行政、政府项目申报等相关工作。任职期间成功组建公司四个项目团队。',
        ...
        for (var i = 0; i < newArr.length; i++) {
            str += (function (num) {
                ...
                return '<div class="summary1 new-card ' + (num == 0 ? 'summary1-active' : '') + '" onclick="goDetail(' + (+num + 1) + ')">'
                    + '<div class="summary-themb"><img class="lazy" data-original="' + obj.imgPath + '" alt=""></div>'
    ...
    createHeader: function () {
        var str = '<div class="top-main">'
            ...
            + '<li class="current">'
            + '<div class="flexbox">'
            + '<a class="first-level" href="index.html" target=""><strong>镜玩首页</strong></a>'
            + '</div>'
            + '</li>'
            + '<li>'
            + '<div class="flexbox">'
            + '<a class="first-level" href="#" target=""><strong>关于镜玩</strong></a>'
            ...
            + '</li>'
            + '<li class="">'
            + '<a class="" href="team.html" target="">核心团队</a>'
            + '</li>'
            + '<li class="">'
            ...
            + '<ul class="subMenu column">'
            + '<li class="">'
            + '<a class="" href="dynamic.html" target="">镜玩动态</a>'
            + '</li>'
            + '</ul>'
            + '</li>'
            + '<li>'
            ...
            + '</li>'
            + '<li class="">'
            + '<a class="" href="https://www.expertol.cn" target="_blank">兔聊</a>'
            + '</li>'
            + '<li class="">'
            + '<a class="" href="https://www.camvivi.cn" target="_blank">来惜</a>'
            + '</li>'
            + '</ul>'
            + '</li>'
            + '<li>'
            + '<div class="flexbox">'
            + '<a class="first-level" href="#" target=""><strong>加入镜玩</strong></a>'
            + '<i class="fa fa-chevron-down"></i>'
            + '</div>'
            + '<ul class="subMenu">'
            + '<li class="">'
            + '<a class="" href="live.html" target="">镜玩生活</a>'
            + '</li>'
            + '<li class="">'
            + '<a class="" href="welf.html" target="">镜玩福利</a>'
            + '</li>'
            + '<li class="">'
    ...
    createFooter: function () {
        $('#footer').html('<div class="footer-contain">'
            ...
            + '    </div>'
            + '    </div>'
            + '<p class="footer-p column">电话：0755-86523543<br>地址：深圳市南山区粤海街道高新技术园南区科技南八路工勘大厦1904</p>'
            + '</div>'
            + '<div class="footer-bottom flexbox">'
            + '    <span>镜玩科技|</span>'
            + '    <a href="https://beian.miit.gov.cn/" target="_blank">粤ICP备16028473号</a>&nbsp;'
            + '    <a href="javascript:void(0);">粤网文1842-215号</a>&nbsp;'
            + '</div>')
    },
}
