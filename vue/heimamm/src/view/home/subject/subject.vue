  ...
  <div class="subject">
    <el-card class="cardHead" style="margin-bottom:20px">
      <el-form :inline="true" :model="form" ref="form">
        ...
        <el-form-item>
          ...
          <el-button class="el-icon-plus" type="primary" @click="add" v-if="$store.state.role != '学生'">新增学科</el-button>
        </el-form-item>
      </el-form>
    </el-card>
    <el-card class="cardBody">
      <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column prop="operate" label="操作" width="200px" v-if="$store.state.role != '学生'">
    ...
    <addSubject ref="addSubject" @addSearch='search' :mode='mode'></addSubject>
  </div>
</template>
...
// 导入子组件
import addSubject from "@/view/home/subject/addSubject";
export default {
  // 注册子组件
  components: {
    addSubject
