<template>
  <el-container class="layout">
    <el-header class="header">
      ...
      <div class="right">
        <img :src="$store.state.userInfo.avatar" alt class="userImg" />
        <span class="userName">{{$store.state.userInfo.username}},你好</span>
        <el-button class="userBtn" @click="quitBtn" size="mini" type="primary">退出</el-button>
      </div>
    </el-header>
    <el-container>
      <el-aside class="aside" width='auto'>
        <el-menu :router="true" :default-active="$route.fullPath" class="el-menu-vertical-demo" :collapse='collapse'>
...
<script>
import { getUserInfo, userQuit } from "@/api/home.js";
