var national = {
  ...
  type: 1,    // 1-元气助攻榜，2-疯狂充值榜
  appBool: openInWebview(), // 是否app内打开
  isLogin: false,   // 是否登录
  dayCashAward: false,  // 今日充值奖励是否领取（0-未领取，1-已领取）
  gradeAlert: 0,    // 解锁等级弹框（0-无，1-5对应解锁的等级）
  isEnd: false,   // 活动是否结束
...
//   var img = "http://miyiurl.rklive888.com/tanabata/dev/image/share.png",
//       title = '中秋闹国庆，放价狂欢',
//       subTitle = '有人暗恋你啦！快领彩礼金，还有直播间拼团充值福利';
