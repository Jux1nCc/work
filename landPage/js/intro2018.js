define("task/page/intro/intro2018", function(a, b, c) {
    "use strict";
    var d = a("lib/zepto")
      , e = a("task/basic/Task")
      , f = a("utils/MetaHandler")
      , g = a("utils/Utils")
      , h = a("widget/box/Toast")
      , i = a("utils/statistic/DAStatistic");
    a("lib/swiper2.min.js");
    var j = d(document.body);
    (new e("intro",function() {
        var a = {
            init: function() {
                var a = this
                  , b = !1
                ...
                d(document).ready(function() {
                    a.mySwiper = a.initSwiper(b),
                    c.on("click", ".u-direction", function() {
                        a.mySwiper.swipeNext()
                    }),
                    e.on("touchend", ".js-dismissal", function() {
            ...
            fixViewport: function() {
                var a = new f;
                a.fixViewportWidth(750)
            },
            checkQuery: function() {
                var a = g.getQueryString("needRegister");
                a === "1" && this.showToast("\u60a8\u8fd8\u4e0d\u662f\u82b1\u7530\u7528\u6237\uff0c\u8bf7\u5148\u4e0b\u8f7d\u82b1\u7530\uff0c\u8fdb\u884c\u6ce8\u518c\u3002")
            },
            ...
            initSwiper: function(a) {
                return new Swiper(".swiper-container",{
                    ...
                    autoResize: !1,
                    watchActiveIndex: !0,
                    onSlideNext: function(b) {
                        b.activeIndex === 4 && !a && (a = !0,
                        i.doStatistic(i.eventName.SLIDE_TO_BOTTOM))
                    }
                })
            }
        };
...
define("utils/MetaHandler", function(a, b, c) {
    "use strict";
    var d = function() {
        function f(c) {
            b[c].content = b[c].seriation.join(","),
            a.setContent(c, b[c].content);
            return a
        }
        function e(a) {
            a = a.replace("-", "_");
        ...
        function d() {
            ...
            for (var d = 0; d < c.length; d++) {
                ...
                b[f] = {},
                b[f].el = c[d],
                b[f].content = c[d].content,
                b[f].seriation = b[f].content.split(","),
                b[f].store = e(f))
            }
            return a
        }
        ...
        this.getContent = function(a) {
            a = a.replace("-", "_");
            return b[a] && b[a].content
        }
        ,
        this.removeContentProperty = function(c, d) {
            var c = c.replace("-", "_")
              , e = d.replace("-", "_");
            if (b[c]) {
                if (b[c].store[e] != null)
                    for (var g = 0; g < b[c].seriation.length; g++)
                        if (b[c].seriation[g].indexOf(d + "=") != -1) {
                            b[c].seriation[g] = null,
                            delete b[c].seriation[g];
                            break
                        }
                f(c)
            }
        ...
        ,
        this.getContentProperty = function(a, c) {
            a = a.replace("-", "_"),
            c = c.replace("-", "_");
            return b[a] && b[a].store[c]
        }
        ,
        this.setContentProperty = function(c, d, e) {
            var c = c.replace("-", "_")
              , g = d.replace("-", "_")
              , h = d + "=" + e;
            if (b[c]) {
                if (b[c].store[g] != null) {
                    b[c].store[g] = e;
                    for (var i = 0; i < b[c].seriation.length; i++)
                        if (b[c].seriation[i].indexOf(d + "=") != -1) {
                            b[c].seriation[i] = h;
                            break
                        }
                } else
                    b[c].store[g] = e,
                    b[c].seriation.push(h);
                f(c)
            }
            return a
        }
        ,
        this.fixViewportWidth = function(b) {
            b = b || a.getContentProperty("viewport", "width");
            if (b != "device-width") {
                var c = window.innerWidth || b
                  , d = window.outerHeight || c
                  , e = window.screen.width || c
                  , f = window.screen.availWidth || c
                  , g = window.innerHeight || b
                  , h = window.outerHeight || g
                  , i = window.screen.height || g
                  , j = window.screen.availHeight || g
                  , k = Math.min(c, d, e, f, g, h, i, j)
                  , l = k / b
                  , m = window.devicePixelRatio
                  , l = Math.min(l, m)
                  , n = navigator.userAgent.match(/android/ig)
                  , o = navigator.userAgent.match(/iphone|ipod|ipad/ig);
                n ? (a.removeContentProperty("viewport", "user-scalable"),
                l < 1 && (a.setContentProperty("viewport", "initial-scale", l),
                a.setContentProperty("viewport", "maximum-scale", l))) : o && !n && a.setContentProperty("viewport", "user-scalable", "no")
            }
        }
        ,
        d()
...
define("widget/box/Toast", function(a, b, c) {
    var d = a("basic/Class")
      , e = a("widget/box/Box")
      , f = a("lib/zepto")
      , g = e.extend({
        renderTmpl: function() {
            return '<div class="box-background toast-background ' + (this.config.classname || "") + '"><div class="box-main toast-main js-toast-main"><span class="text js-text">' + this.data + "</span></div></div>"
        },
        postRender: function() {
            this.$toastMain = this.$elem.find(".js-toast-main"),
            this.$text = this.$elem.find(".js-text")
        },
        onShow: function() {
            var a = this;
        ...
        setPosition: function(a) {
            a = a || this.config.position,
            this.config.position = a;
            switch (a) {
            case "top":
                this.$toastMain.addClass("on-top");
                break;
            case "bottom":
                this.$toastMain.addClass("on-bottom");
                break;
            case "middle":
                this.$toastMain.addClass("on-middle");
                break;
            default:
                a = parseFloat(a),
                isNaN(a) || this.$toastMain.css("top", a + "px")
            }
            return this
        }
    });
    ...
    var d = a("basic/Class")
      ...
      , g = d.extend({
        ...
        render: function() {
            ...
            this.$elem || (this.$elem = e(this.renderTmpl(a)).appendTo("body")),
            this.postRender(),
            this.setPosition(),
            f.push(this)
        },
        ...
        bindEvent: function() {
            this.$elem.delegate(".close-trigger", "click", e.proxy(this.hide, this))
        },
        show: function() {
            this.$elem.show(),
            this.isShow = !0,
...
define("lib/swiper2.min.js", function(a, b, c) {
    window.Swiper = function(a, b) {
        ...
        function A() {
            ba = setTimeout(function() {
                b.loop ? (D.fixLoop(),
                D.swipeNext(!0, !0)) : D.swipeNext(!0, !0) || (b.autoplayStopOnLast ? (clearTimeout(ba),
                ba = void 0) : D.swipeTo(0)),
                D.wrapperTransitionEnd(function() {
                    "undefined" != typeof ba && A()
                })
            }, b.autoplay)
        }
        function z(a) {
        ...
        (document.querySelectorAll || window.jQuery) && "undefined" != typeof a && (a.nodeType || 0 !== c(a).length)) {
            ...
            D.resizeFix = function(a) {
                ...
                b.autoplay && (D.support.transitions && "undefined" != typeof ba ? "undefined" != typeof ba && (clearTimeout(ba),
                ba = void 0,
    ...
    "undefined" != typeof c ? c.exports = Swiper : "function" == typeof define && define.amd && define([], function() {
        "use strict";
        return Swiper
    })
});
define("task/widget/visitStatistic", function(a, b, c) {
    "use strict";
    var d = a("task/basic/Task")
      , e = a("utils/statistic/DAStatistic")
      , f = a("utils/Utils");
    (new d("visitStatistic",function() {
        e.doStatistic(e.eventName.VIEW_3G_PAGE)
    }
    )).add()
});
define("page/intro/intro2018", function(a, b, c) {
    a("task/group/common"),
    a("task/page/intro/intro2018"),
    a("task/widget/visitStatistic"),
    a("task/basic/TaskManager").run()
});
