! function(e) {
	...
	var i = function() {
		...
		o = function() {
			...
			return i(e, null, [{
				key: "detectIEVersion",
				value: function() {
					for(var e = 4, t = document.createElement("div"), r = t.getElementsByTagName("i"); t.innerHTML = "\x3c!--[if gt IE " + e + "]><i></i><![endif]--\x3e", r[0];) e++;
					return e > 4 && e
				}
			}, {
				key: "extend",
	...
	n = [], void 0 !== (i = function() {
		return s
	}.apply(t, n)) && (e.exports = i), window.AliyunUpload = s
}, function(e, t, r) {
	"use strict";
		...
		A = function() {
			...
			return o(e, [{
				...
				value: function(e, t, r, n) {
					return this._retryCount = 0, !(r && !n || !r && n) && (!(e && !t || !e && t) && (this._ossCreditor.accessKeyId = e, this._ossCreditor.accessKeySecret = t, this._ossCreditor.securityToken = r, this._ossCreditor.expireTime = n, !0))
				}
			}, {
				key: "addFile",
				value: function(e, t, r, n, i) {
					...
					for(var o = (this.options, 0); o < this._uploadList.length; o++)
						if(this._uploadList[o].file == e) return !1;
					var s = new Object;
					return s.file = e, s._endpoint = t, s._bucket = r, s._object = n, s.state = a.UPLOADSTATE.INIT, s.isImage = v.default.isImage(e.name), i && (s.videoInfo = i ? JSON.parse(i).Vod : {}, s.userData = l.default.encode(i)), s.ri = m.default.create(), this._uploadList.push(s), this._reportLog("20001", s, {
				...
				value: function(e) {
					...
					if(e == this._curIndex && t.state == a.UPLOADSTATE.UPLOADING) {
						...
						r && r.checkpoint && (r = r.checkpoint), r && this._ossUpload.abort(t), this._removeCheckoutpoint(t), this.nextUpload()
				...
				key: "clear",
				value: function(e) {
					for(var t = this.options, r = 0, n = 0; n < this._uploadList.length; n++) t.uploadList[n].state == a.UPLOADSTATE.SUCCESS && r++, this._uploadList[n].state == e && (t.uploadList.splice(n, 1), n--);
				...
				value: function(e, t, r, n) {
					...
					var i = "";
					return this._uploadList.length > this._curIndex && (i = this._uploadList[this._curIndex]), i && (this.init(e, t, r, n), this._state = a.VODSTATE.START, this._ossUpload = null, this._uploadCore(i, i.retry), i.retry = !1), !0
				}
			}, {
				...
				value: function(e, t, r, n, i) {
					if(!(t && r && n && i)) return console.log("accessKeyId、ccessKeySecret、securityToken and expiration should not be empty."), !1;
					this._ut = "oss";
					var o = e;
					this.init(t, r, n, i), o.endpoint = o._endpoint, o.bucket = o._bucket, o.object = o._object, this._ossUpload = null, this._uploadCore(o, e.retry), e.retry = !1
				}
			}, {
				key: "setSTSToken",
				value: function(e, t, r, n) {
					if(!t || !r || !n) return console.log("accessKeyId、ccessKeySecret、securityToken should not be empty."), !1;
					...
					i.ImageType && (o.imageType = i.ImageType), i.ImageExt && (o.imageExt = i.ImageExt), i.FileSize && (o.fileSize = i.FileSize), i.Description && (o.description = i.Description), i.CateId && (o.cateId = i.CateId), i.Tags && (o.tags = i.Tags), i.TemplateGroupId && (o.templateGroupId = i.TemplateGroupId), i.StorageLocation && (o.storageLocation = i.StorageLocation), i.CoverURL && (o.coverUrl = i.CoverURL), i.TransCodeMode && (o.transCodeMode = i.TransCodeMode), i.UserData && (o.userData = i.UserData);
					var s = this,
						u = "getUploadAuth";
					e.videoId ? (o.videoId = e.videoId, u = "refreshUploadAuth") : e.isImage && (u = "getImageUploadAuth"), w.default[u](o, function(t) {
				...
				value: function(e, t, r, n) {
					...
					var o = {};
					if(r) {
						if(o = JSON.parse(l.default.decode(r)), !o.Endpoint || !o.Bucket || !o.FileName) return console.error("uploadAddress is invalid"), !1
					} else o.Endpoint = a.endpoint, o.Bucket = a.bucket, o.FileName = a.object;
					this._ut = "vod", this._uploadWay = "vod";
					var a = e;
					this.init(i.AccessKeyId, i.AccessKeySecret, i.SecurityToken, i.Expiration), a.endpoint = a._endpoint ? a._endpoint : o.Endpoint, a.bucket = a._bucket ? a._bucket : o.Bucket, a.object = a._object ? a._object : o.FileName, n && (a.videoId = n), this._ossUpload = null, this._uploadCore(a, e.retry), e.retry = !1
				}
			}, {
				...
				value: function(e, t, r, n) {
					...
					var i = {
						...
						o = this,
						s = "refreshUploadAuth";
					e.isImage && (s = "getImageUploadAuth"), w.default[s](i, function(t) {
						o.setUploadAuthAndAddress(e, t.UploadAuth, UploadAddress), o._state = a.VODSTATE.START
					}, function(t) {
						o._error(e, {
							name: t.Code,
							code: t.Code,
				...
				value: function(e) {
					...
					if(e.retry = t, r.onUploadstarted && !t) try {
						...
						n && n.state != a.UPLOADSTATE.UPLOADING && (e.checkpoint = n, e.videoId = n.videoId), r.onUploadstarted(e)
					} catch(e) {
						console.log(e)
					}
				}
				...
				value: function(e) {
					...
					var r = v.default.getFileType(e.file.name),
						...
						i = "",
						o = "";
					n && n.checkpoint && (o = n.state, i = n.videoId, n = n.checkpoint), n && i == e.videoId && o != a.UPLOADSTATE.UPLOADING && (n.file = e.file, e.checkpoint = n, n.uploadId);
					...
					if("cancel" == t.name) try {
						...
						if(("RequestTimeoutError" == t.name || "ConnectionTimeout" == t.name || "ConnectionTimeoutError" == t.name) && this._retryTotal > this._retryCount) {
							...
							return setTimeout(function() {
								r._uploadCore(e, !0)
							}, 1e3 * r._retryDuration), void this._retryCount++
						}
				...
				value: function(e, t) {
					...
					var r = 0;
					t && t.res && t.res.headers && (r = t.res.headers["x-oss-request-id"]), this._removeCheckoutpoint(e);
					var n = this;
					setTimeout(function() {
						n.nextUpload()
					}, 100), this._retryCount = 0, this._reportLog("20003", e, {
						requestId: r
					})
				}
			}, {
				...
				value: function(e, t, r) {
					...
					var n = t.checkpoint,
						i = 0;
					n && (e.checkpoint = n, this._saveCheckoutpoint(e, n, a.UPLOADSTATE.UPLOADING), i = n.uploadId), this._retryCount = 0;
					var o = this._getPortNumber(n),
						s = 0;
					r && r.headers && (s = r.headers["x-oss-request-id"]), 0 != t.loaded && this._reportLog("20007", e, {
						pn: o,
						requestId: s
				...
				key: "_reportLog",
				value: function(e, t, r) {
					r || (r = {}), r.ri = t.ri, this._ut && (r.ut = this._ut), this._log.log(e, r)
				}
			}, {
				key: "_initEvent",
				value: function() {
		...
		c = (n(u), function() {
			function e(t, r) {
				if(i(this, e), t) {
					...
					var n = function() {};
					this._callback.onerror = r.onerror || n, this._callback.oncomplete = r.oncomplete || n, this._callback.onprogress = r.onprogress || n
				}
			}
			return o(e, [{
				key: "create",
				...
				value: function(e, t) {
					...
					t.headers && (i.headers = t.headers), e.checkpoint && (i.checkpoint = e.checkpoint), e.bucket || (this.oss.options.bucket = e.bucket), e.endpoint || (this.oss.options.endpoint = e.endpoint), this.oss.multipartUpload(e.object, e.file, i).then(function(e, t) {
						...
						r.oss.cancel && (r.oss && r.oss.isCancel() ? console.log("oss is cancel as error") : r.oss.cancel()), r._error(e)
					})
				}
			}, {
				key: "header",
	...
	(function(e) {
		...
		function m(e, t, r, n, i) {
			...
			if("number" == typeof t) return t &= 255, o.TYPED_ARRAY_SUPPORT && "function" == typeof Uint8Array.prototype.indexOf ? i ? Uint8Array.prototype.indexOf.call(e, t, r) : Uint8Array.prototype.lastIndexOf.call(e, t, r) : T(e, [t], r, n, i);
		...
		o.prototype.slice = function(e, t) {
			...
			return e = +e, t |= 0, r || D(this, e, t, 2, 65535, 0), o.TYPED_ARRAY_SUPPORT ? (this[t] = 255 & e, this[t + 1] = e >>> 8) : M(this, e, t, !0), t + 2
		}, o.prototype.writeUInt16BE = function(e, t, r) {
			return e = +e, t |= 0, r || D(this, e, t, 2, 65535, 0), o.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 8, this[t + 1] = 255 & e) : M(this, e, t, !1), t + 2
		}, o.prototype.writeUInt32LE = function(e, t, r) {
			return e = +e, t |= 0, r || D(this, e, t, 4, 4294967295, 0), o.TYPED_ARRAY_SUPPORT ? (this[t + 3] = e >>> 24, this[t + 2] = e >>> 16, this[t + 1] = e >>> 8, this[t] = 255 & e) : B(this, e, t, !0), t + 4
		}, o.prototype.writeUInt32BE = function(e, t, r) {
			return e = +e, t |= 0, r || D(this, e, t, 4, 4294967295, 0), o.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = 255 & e) : B(this, e, t, !1), t + 4
			...
			return e = +e, t |= 0, r || D(this, e, t, 2, 32767, -32768), o.TYPED_ARRAY_SUPPORT ? (this[t] = 255 & e, this[t + 1] = e >>> 8) : M(this, e, t, !0), t + 2
		}, o.prototype.writeInt16BE = function(e, t, r) {
			return e = +e, t |= 0, r || D(this, e, t, 2, 32767, -32768), o.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 8, this[t + 1] = 255 & e) : M(this, e, t, !1), t + 2
		}, o.prototype.writeInt32LE = function(e, t, r) {
			return e = +e, t |= 0, r || D(this, e, t, 4, 2147483647, -2147483648), o.TYPED_ARRAY_SUPPORT ? (this[t] = 255 & e, this[t + 1] = e >>> 8, this[t + 2] = e >>> 16, this[t + 3] = e >>> 24) : B(this, e, t, !0), t + 4
		}, o.prototype.writeInt32BE = function(e, t, r) {
			return e = +e, t |= 0, r || D(this, e, t, 4, 2147483647, -2147483648), e < 0 && (e = 4294967295 + e + 1), o.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = 255 & e) : B(this, e, t, !1), t + 4
	...
	function o(e) {
		...
		var u = 0;
		for(t = 0; t < r; t += 4) i = f[e.charCodeAt(t)] << 18 | f[e.charCodeAt(t + 1)] << 12 | f[e.charCodeAt(t + 2)] << 6 | f[e.charCodeAt(t + 3)], a[u++] = i >> 16 & 255, a[u++] = i >> 8 & 255, a[u++] = 255 & i;
	...
	var i = function() {
		...
		o = function(e) {
			...
			return i && (r = "macOS"), "X11" == navigator.platform && !n && !i && (r = "Unix"), String(navigator.platform).indexOf("Linux") > -1 && (r = "Linux"), n ? "windows" : r
		},
		a = function() {
		...
		u = function() {
			...
			return e.tablet = !!(f || A || u && !r.match(/Mobile/) || b && r.match(/Tablet/) || I && !r.match(/Phone/) && r.match(/Touch/)), e.phone = !(e.tablet || e.ipod || !(u || h || d || m || T || S && r.match(/Android/) || S && r.match(/CriOS\/([\d.]+)/) || b && r.match(/Mobile/) || I && r.match(/Touch/))), e.pc = !e.tablet && !e.phone, c ? e.name = "macOS" : p ? (e.name = "windows", e.version = a()) : e.name = o(e), t.name = s(t), {
				os: e,
				browser: t
			}
		}(),
	...
	var o = function() {
		...
		f = function() {
			...
			return o(e, null, [{
				...
				value: function(e, t, r) {
					var n = (c.default.randomUUID(), c.default.randomUUID()),
						i = {
							AccessKeyId: e.accessKeyId,
				...
				value: function(e, t, r) {
					...
					e.fileSize && (i.FileSize = e.fileSize), e.description && (i.Description = e.description), e.cateId && (i.CateId = e.cateId), e.tags && (i.Tags = e.tags), e.templateGroupId && (i.TemplateGroupId = e.templateGroupId), e.storageLocation && (i.StorageLocation = e.storageLocation), e.coverUrl && (i.CoverURL = e.coverUrl), e.transCodeMode && (i.TransCodeMode = e.transCodeMode), e.userData && (i.UserData = e.userData);
				...
				value: function(e, t, r) {
					...
					e.title && (i.Title = e.title), e.imageExt && (i.ImageExt = e.imageExt), e.tags && (i.Tags = e.tags), e.storageLocation && (i.StorageLocation = e.storageLocation);
					var o = c.default.makeUTF8sort(i, "=", "&") + "&Signature=" + c.default.aliyunEncodeURI(c.default.makeChangeSiga(i, e.accessKeySecret)),
						a = "https://vod.cn-shanghai.aliyuncs.com/?" + o;
					s.default.get(a, function(e) {
						var e = JSON.parse(e);
	...
	var i = function() {
		...
		o = function() {
			...
			return i(e, null, [{
				...
				value: function(e, t, r, n, i) {
					var o;
					r = r || function() {}, "undefined" == typeof XMLHttpRequest && (window.XMLHttpRequest = function() {
						try {
					...
					try {
						void 0 === n && (n = !0), o.open("GET", e, n), i && (o.withCredentials = !0)
					} catch(e) {
						return void r(e)
					}
					try {
			...
			var t = e,
				...
				s = o.SHA1 = i.extend({
					...
					_doProcessBlock: function(e, t) {
						for(var r = this._hash.words, n = r[0], i = r[1], o = r[2], s = r[3], u = r[4], c = 0; c < 80; c++) {
							if(c < 16) a[c] = 0 | e[t + c];
							else {
							...
							l += c < 20 ? 1518500249 + (i & o | ~i & s) : c < 40 ? 1859775393 + (i ^ o ^ s) : c < 60 ? (i & o | i & s | o & s) - 1894007588 : (i ^ o ^ s) - 899497514, u = s, s = o, o = i << 30 | i >>> 2, i = n, n = l
						}
						r[0] = r[0] + n | 0, r[1] = r[1] + i | 0, r[2] = r[2] + o | 0, r[3] = r[3] + s | 0, r[4] = r[4] + u | 0
					},
			...
			o.Base64 = {
				stringify: function(e) {
					...
					for(var i = [], o = 0; o < r; o += 3)
						for(var a = t[o >>> 2] >>> 24 - o % 4 * 8 & 255, s = t[o + 1 >>> 2] >>> 24 - (o + 1) % 4 * 8 & 255, u = t[o + 2 >>> 2] >>> 24 - (o + 2) % 4 * 8 & 255, c = a << 16 | s << 8 | u, f = 0; f < 4 && o + .75 * f < r; f++) i.push(n.charAt(c >>> 6 * (3 - f) & 63));
					var l = n.charAt(64);
					if(l)
