/*! Aliplayer - v2.8.0 - 2018-11-29 */ ! function o(a, s, l) {
	function c(i, e) {
		if(!s[i]) {
			if(!a[i]) {
	...
	1: [function(e, t, i) {
		var r, n;
		r = this, n = function() {
			var u, i, e, t, r, d, n, o, a, s, l, c, p = p || (u = Math, i = Object.create || function() {
				function i() {}
				return function(e) {
					var t;
				...
				random: function(e) {
					for(var t, i = [], r = function(t) {
							...
							return function() {
								...
								return e /= 4294967296, (e += .5) * (.5 < u.random() ? 1 : -1)
							}
						}, n = 0; n < e; n += 4) {
	...
	5: [function(e, t, i) {
		...
		r = this, n = function(e) {
			var t, i, c;
			i = (t = e).lib.Base, c = t.enc.Utf8, t.algo.HMAC = i.extend({
				init: function(e, t) {
					e = this._hasher = new e.init, "string" == typeof t && (t = c.parse(t));
					var i = e.blockSize,
						r = 4 * i;
					t.sigBytes > r && (t = e.finalize(t)), t.clamp();
					for(var n = this._oKey = t.clone(), o = this._iKey = t.clone(), a = n.words, s = o.words, l = 0; l < i; l++) a[l] ^= 1549556828, s[l] ^= 909522486;
			...
			return i = (t = e).lib, r = i.WordArray, n = i.Hasher, o = t.algo, d = [], a = o.SHA1 = n.extend({
				...
				_doProcessBlock: function(e, t) {
					for(var i = this._hash.words, r = i[0], n = i[1], o = i[2], a = i[3], s = i[4], l = 0; l < 80; l++) {
						...
						u += l < 20 ? 1518500249 + (n & o | ~n & a) : l < 40 ? 1859775393 + (n ^ o ^ a) : l < 60 ? (n & o | n & a | o & a) - 1894007588 : (n ^ o ^ a) - 899497514, s = a, a = o, o = n << 30 | n >>> 2, n = r, r = u
					}
					i[0] = i[0] + r | 0, i[1] = i[1] + n | 0, i[2] = i[2] + o | 0, i[3] = i[3] + a | 0, i[4] = i[4] + s | 0
				},
				_doFinalize: function() {
					var e = this._data,
						...
						r = 8 * e.sigBytes;
					return t[r >>> 5] |= 128 << 24 - r % 32, t[14 + (r + 64 >>> 9 << 4)] = Math.floor(i / 4294967296), t[15 + (r + 64 >>> 9 << 4)] = i, e.sigBytes = 4 * t.length, this._process(), this._hash
				},
				clone: function() {
	...
	7: [function(e, t, i) {
		! function() {
			...
			s.prototype.needsClick = function(e) {
				...
				} else if(this.needsFocus(a)) return 100 < e.timeStamp - i || c && window.top !== window && "input" === r ? this.targetElement = null : (this.focus(a), this.sendClick(a, e), c && "select" === r || (this.targetElement = null, e.preventDefault())), !1;
			...
			l = r.extend({
				...
				bindEvent: function() {
					...
					o.on(e, "click", function() {
						r._player._changeStream && r._switchUrl && r._player._changeStream(r._switchUrl.index, a.get("Quality_Change_Text")), n.css(r.el(), "display", "none")
					});
		...
		var r = e("../ui/component"),
			...
			p = r.extend({
				...
				bindEvent: function() {
					...
					c.domain ? -1 < c.domain.indexOf("localhost") && (t = "//" + c.domain + "/build/skins/default/img/dragcursor.png") : t = "de/prismplayer/" + c.h5Version + "/skins/default/img/dragcursor.png", e.src = t, n.on(this.cursorNode, "mousedown", function(e) {
						i._onMouseDown(e)
						...
						i._onMouseOut(e)
					}), this.bindTimeupdate = a.bind(this, this._onTimeupdate), this._player.on(d.Player.TimeUpdate, this.bindTimeupdate), u.isLiveShift(this._player._options) && this._player.on(d.Player.Play, function() {
				...
				_onMouseClick: function(e) {
					...
					o ? t._player.seek(i) : t._player._loadByUrlInner(n, i, !0), t._player.trigger(d.Private.Play_Btn_Hide), t._liveshiftService.seekTime = i, t._player.trigger(d.Private.EndStart, {
						toTime: i,
						notPlay: !0
					}), t._updateCursorPosition(i), o && setTimeout(function() {
						t._player.play()
					})
				},
				...
				_updateCursorPosition: function(e) {
					if(1 != this._player._switchSourcing && (0 != e || 0 != this._player.tag.readyState)) {
						...
						0 != n && (r = 1 - 18 / n), this.cursorNode && (r < t ? (s.css(this.cursorNode, "right", "0px"), s.css(this.cursorNode, "left", "auto")) : (s.css(this.cursorNode, "right", "auto"), s.css(this.cursorNode, "left", 100 * t + "%")))
					}
				}
			});
		t.exports = p
	...
	12: [function(e, t, i) {
		...
		n.players = {}, "function" == typeof define && define.amd ? define([], function() {
			return o
	...
	13: [function(e, t, i) {
		...
		o.prototype.handle = function(e) {
			if(this._options.autoPlayDelay) {
				...
				t || (t = n.get("AutoPlayDelayDisplayText").replace("$$", this._options.autoPlayDelay)), this._player.trigger("info_show", t), this._player.trigger("h5_loading_hide"), this._player.trigger("play_btn_hide");
				var i = this;
	...
	14: [function(e, t, i) {
		t.exports = t.exports = {
			...
			Error_Not_Support_Format_On_Mobile: "flv銆乺mtp can't be supported on mobile锛宲lease use m3u8",
	...
	15: [function(e, t, i) {
		t.exports = t.exports = {
			...
			Auto_Stream_Tip_Text: "Internet is slow, does switch to $$",
			Open_Html_By_File: "Html page should be on the server",
			Cant_Use_Flash_On_Mobile: "Mobile doesn't support flash player锛宲lease use h5 player"
		}
	}, {}],
	16: [function(e, t, i) {
		t.exports = t.exports = {
			...
			Fetch_Playauth_Error: "鑾峰彇鎾斁鍑瘉鍑洪敊鍟︼紝璇峰皾璇曢€€鍑洪噸璇曟垨鍒锋柊",
			Open_Html_By_File: "涓嶈兘鐩存帴鍦ㄦ祻瑙堝櫒鎵撳紑html鏂囦欢锛岃閮ㄧ讲鍒版湇鍔＄",
			Cant_Use_Flash_On_Mobile: "绉诲姩绔笉鏀寔Flash鎾斁鍣紝璇蜂娇鐢╤5鎾斁鍣�"
		}
	}, {}],
	17: [function(o, e, t) {
		var i = o("../config"),
			...
			l = function(e, t) {
				var i = d(e),
					r = "",
					n = u();
				r = "flash" == e ? "en-us" == n ? o("./flash/en-us") : "zh-cn" == n ? o("./flash/zh-cn") : t[n] : "en-us" == n ? o("./en-us") : "zh-cn" == n ? o("./zh-cn") : t[n], a.set(i, JSON.stringify(r)), c(e, r)
			},
			c = function(e, t) {
				var i = d(e);
				window[i] = t
	...
	18: [function(e, t, i) {
		t.exports = t.exports = {
			...
			Quality_Change_Text: "姝ｅ湪涓烘偍鍒囨崲鍒� ",
			...
			Error_Not_Support_encrypt_Text: "h5涓嶆敮鎸佸姞瀵嗚棰戠殑鎾斁锛岃璁剧疆useFlashPrism涓簍rue",
			...
			Error_Playauth_Expired_Text: "鍑瘉宸茶繃鏈燂紝璇峰皾璇曢€€鍑洪噸璇曟垨鍒锋柊",
			Error_MTS_Fetch_Urls_Text: "MTS鑾峰彇鍙栨暟澶辫触",
			...
			OK_Text: "纭",
			Auto_Stream_Tip_Text: "缃戠粶涓嶇粰鍔涳紝鏄惁鍒囨崲鍒�$$",
			Request_Block_Text: "娴忚鍣ㄥ畨鍏ㄧ瓥鐣ヨ棰戝湴鍧€涓嶈兘涓篽ttp鍗忚锛屼笌缃戠珯https鍗忚涓嶄竴鑷�",
			Open_Html_By_File: "涓嶈兘鐩存帴鍦ㄦ祻瑙堝櫒鎵撳紑html鏂囦欢锛岃閮ㄧ讲鍒版湇鍔＄",
			Maybe_Cors_Error: "璇风‘璁ゆ槸鍚﹀紑鍚簡鍏佽璺ㄥ煙璁块棶<a href='https://help.aliyun.com/document_detail/62950.html?spm=a2c4g.11186623.2.21.Y3n2oi' target='_blank'>鍙傝€冩枃妗�</a>",
			Speed_Switch_To: "鍊嶉€熷垏鎹㈠埌 ",
			Curent_Volume: "褰撳墠闊抽噺锛�",
			Volume_Mute: "璁剧疆涓洪潤闊�",
			Volume_UnMute: "璁剧疆涓洪潪闈欓煶",
			ShiftLiveTime_Error: "鐩存挱寮€濮嬫椂闂翠笉鑳藉ぇ浜庣洿鎾粨鏉熸椂闂�",
			Error_Not_Support_Format_On_Mobile: "绉诲姩绔笉鏀寔flv銆乺mtp瑙嗛锛岃浣跨敤m3u8",
			SessionId_Ticket_Invalid: "DRM瑙嗛鎾斁锛宻essionId鍜宼icket灞炴€т笉鑳戒负绌�",
			Http_Error: "Http缃戠粶璇锋眰澶辫触",
			Http_Timeout: "http璇锋眰瓒呮椂",
			DRM_License_Expired: "DRM license瓒呮椂锛岃鍒锋柊",
			Not_Support_DRM: "娴忚鍣ㄤ笉鏀寔DRM瑙嗛鐨勬挱鏀�",
			CC_Switch_To: "瀛楀箷鍒囨崲鍒� ",
			AudioTrack_Switch_To: "闊宠建鍒囨崲鍒� ",
			Subtitle: "瀛楀箷",
			AudioTrack: "闊宠建",
			Quality: "娓呮櫚搴�",
			Auto: "鑷姩",
			Quality_Switch_To: "娓呮櫚搴﹀垏鎹㈠埌 ",
			Fullscreen: "鍏ㄥ睆",
			Setting: "璁剧疆",
			Volume: "闊抽噺",
			Play: "鎾斁",
			Pause: "鏆傚仠",
			CloseSubtitle: "鍏抽棴瀛楀箷",
			OpenSubtitle: "鎵撳紑瀛楀箷",
			ExistFullScreen: "閫€鍑哄叏灞�",
			Muted: "闈欓煶",
			Retry: "閲嶈瘯",
			SwitchToLive: "杩斿洖鐩存挱"
		}
	...
	19: [function(e, t, i) {
		...
		if(window.Uint8Array)
			for(var d = new Uint8Array(256), r = 0; r < o.length; r++) d[o.charCodeAt(r)] = r;
		var c = function(e) {
		...
		unpackPlayReady = function(e) {
			...
			decode: function(e) {
				var t, i, r, n, o, a = .75 * e.length,
					s = e.length,
					l = 0;
				"=" === e[e.length - 1] && (a--, "=" === e[e.length - 2] && a--);
				var c = new ArrayBuffer(a),
					u = new Uint8Array(c);
				for(t = 0; t < s; t += 4) i = d[e.charCodeAt(t)], r = d[e.charCodeAt(t + 1)], n = d[e.charCodeAt(t + 2)], o = d[e.charCodeAt(t + 3)], u[l++] = i << 2 | r >> 4, u[l++] = (15 & r) << 4 | n >> 2, u[l++] = (3 & n) << 6 | 63 & o;
				return c
			},
			encode: function(e) {
				var t, i = new Uint8Array(e),
					r = i.length,
					n = "";
				for(t = 0; t < r; t += 3) n += o[i[t] >> 2], n += o[(3 & i[t]) << 4 | i[t + 1] >> 4], n += o[(15 & i[t + 1]) << 2 | i[t + 2] >> 6], n += o[63 & i[t + 2]];
	...
	24: [function(e, n, t) {
		...
		n.exports.el = function(e) {
			...
			if(t = {}, i = ",autoplay,controls,loop,muted,default,", e && e.attributes && 0 < e.attributes.length)
				for(var a = (r = e.attributes).length - 1; 0 <= a; a--) n = r[a].name, o = r[a].value, "boolean" != typeof e[n] && -1 === i.indexOf("," + n + ",") || (o = null !== o), t[n] = o;
			return t
	...
	25: [function(e, l, t) {
		...
		l.exports.on = function(o, e, t) {
			if(c.isArray(e)) return d(l.exports.on, o, e, t);
			i.IS_MOBILE && "click" == e && r(o);
			var a = u.getData(o);
			a.handlers || (a.handlers = {}), a.handlers[e] || (a.handlers[e] = []), t.guid || (t.guid = u.guid()), a.handlers[e].push(t), a.dispatcher || (a.disabled = !1, a.dispatcher = function(e) {
				if(!a.disabled) {
					e = l.exports.fixEvent(e);
					var t = a.handlers[e.type];
					if(t)
						for(var i = t.slice(0), r = 0, n = i.length; r < n && !e.isImmediatePropagationStopped(); r++) i[r].call(o, e)
				}
			...
			if(u.hasData(t)) {
				var r = u.getData(t);
				if(r.handlers) {
					if(c.isArray(e)) return d(l.exports.off, t, e, i);
					var n = function(e) {
					...
					if(e) {
						...
						for(var s in r.handlers) n(s)
				}
			}
		}, l.exports.cleanUpEvents = function(e, t) {
			var i = u.getData(e);
			0 === i.handlers[t].length && (delete i.handlers[t], e.removeEventListener ? e.removeEventListener(t, i.dispatcher, !1) : e.detachEvent && e.detachEvent("on" + t, i.dispatcher)), c.isEmpty(i.handlers) && (delete i.handlers, delete i.dispatcher, delete i.disabled), c.isEmpty(i) && u.removeData(e)
			...
			if("string" == typeof t) {
				var n = null;
				(e.paramData || 0 == e.paramData) && (n = e.paramData, e.paramData = null, e.removeAttribute(n)), t = {
					type: t,
					target: e,
					paramData: n
				}
			...
			if(c.isArray(t)) return d(l.exports.one, e, t, i);
			var r = function() {
				l.exports.off(e, t, r), i.apply(this, arguments)
			};
			r.guid = i.guid = i.guid || u.guid(), l.exports.on(e, t, r)
		}
	}, {
		"./data": 23,
		"./object": 32,
		...
		var r = /^((?:[a-zA-Z0-9+\-.]+:)?)(\/\/[^\/\;?#]*)?(.*?)??(;.*?)?(\?.*?)?(#.*?)?$/,
			...
			d = {
				buildAbsoluteURL: function(e, t, i) {
					...
					if(!n.netLoc && (s.netLoc = o.netLoc, "/" !== n.path[0]))
						if(n.path) {
							var l = o.path,
					...
					return null === s.path && (s.path = i.alwaysNormalize ? d.normalizePath(n.path) : n.path), d.buildURLFromParts(s)
				},
				parseURL: function(e) {
					var t = r.exec(e);
					return t ? {
			...
			parseLevelPlaylist: function(e, t, i, r) {
				...
				for(P.lastIndex = 0; null !== (n = P.exec(e));) {
					...
					if(h) {
						...
						if(!isNaN(p.duration)) {
							var v = a++;
							p.type = r, p.start = s, p.levelkey = c, p.sn = v, p.level = i, p.cc = u, p.baseurl = t, p.relurl = (" " + n[3]).slice(1), l.fragments.push(p), s += (d = p).duration, p = new I
						}
					} else if(n[4]) {
					...
					} else if(n[5]) p.rawProgramDateTime = (" " + n[5]).slice(1), p.tagList.push(["PROGRAM-DATE-TIME", p.rawProgramDateTime]), void 0 === l.programDateTime && (l.programDateTime = new Date(new Date(Date.parse(n[5])) - 1e3 * s));
					else {
	...
	30: [function(e, s, t) {
		...
		s.exports.get = function(e, t, i, r, n) {
			...
			}), c = new XMLHttpRequest, u = h.parseUrl(t), d = window.location, !(u.protocol + u.host !== d.protocol + d.host) || !window.XDomainRequest || "withCredentials" in c ? (l = "file:" == u.protocol || "file:" == d.protocol, c.onreadystatechange = function() {
			...
			try {
				if(void 0 === o && (o = !0), c.open(e, t, o), a && (c.withCredentials = !0), s)
					for(var p in s) c.setRequestHeader(p, s[p])
			} catch(e) {
				return void n(e)
			}
			try {
	...
	34: [function(e, f, t) {
		...
		f.exports.defaultH5Layout = [{
			...
			var t, i = e.id;
			if("string" == typeof i ? (0 === i.indexOf("#") && (i = i.slice(1)), t = r.el(i)) : t = i, !t || !t.nodeName) throw new TypeError("娌℃湁涓烘挱鏀惧櫒鎸囧畾瀹瑰櫒");
			...
			var i = t;
			if(!i && !(i = n.get(o.SelectedStreamLevel))) return n.set(o.SelectedStreamLevel, e[0].definition, 365), 0;
			...
			var i = v.merge(v.copy(_), e),
				...
				n = !1;
			if(e.useFlashPrism || f.exports.isRTMP(e.source)) n = !0, r = [{
				name: "liveIco",
				align: "tlabs",
				x: 15,
				y: 25
					...
					if("controlBar" == i.skinLayout[c].name) {
						...
						for(var u = i.skinLayout[c].children.length, d = 0; d < u; d++) {
							...
							if("liveDisplay" == p || "liveIco" == p || "fullScreenButton" == p || "volume" == p || "snapshot" == p || "setting" == p || "subtitle" == p || o && ("progress" == p || "playButton" == p || "timeDisplay" == p)) {
								...
								"progress" == p ? h.name = "liveShiftProgress" : "timeDisplay" == p ? h.name = "liveShiftTimeDisplay" : n && "liveDisplay" == p && (h.name = "liveIco"), s.push(h)
							}
						}
						break
					} - 1 != l && (i.skinLayout[l].children = s)
			}
			return(void 0 === e.components || !e.components || v.isArray(e.components) && 0 == e.components.length) && "false" != e.components && (i.components = [y]), i
		}
	}, {
		"../config": 11,
	...
	38: [function(e, D, t) {
		...
		var r, n, o, a;
		D.exports.IS_MAC_SAFARI = D.exports.IS_MAC && D.exports.IS_SAFARI && !D.exports.IS_CHROME && !D.exports.HAS_FLASH, D.exports.IS_IOS = D.exports.IS_IPHONE || D.exports.IS_IPAD || D.exports.IS_IPOD, D.exports.IOS_VERSION = function() {
			...
			function(e, t) {
				var i, r, n, o, a = this.os = {},
					...
					d = e.match(/(iPad).*OS\s([\d_]+)/),
					p = e.match(/(iPod)(.*OS\s([\d_]+))?/),
					h = !d && e.match(/(iPhone\sOS)\s([\d_]+)/),
					f = e.match(/(webOS|hpwOS)[\s\/]([\d.]+)/),
					v = /Win\d{2}|Windows/.test(t),
					y = e.match(/Windows Phone ([\d.]+)/),
					_ = f && e.match(/TouchPad/),
					g = e.match(/Kindle\/([\d.]+)/),
					m = e.match(/Silk\/([\d._]+)/),
				...
				if((s.webkit = !!l) && (s.version = l[1]), c && (a.android = !0, a.version = c[2]), h && !p && (a.ios = a.iphone = !0, a.version = h[2].replace(/_/g, ".")), d && (a.ios = a.ipad = !0, a.version = d[2].replace(/_/g, ".")), p && (a.ios = a.ipod = !0, a.version = p[3] ? p[3].replace(/_/g, ".") : null), y && (a.wp = !0, a.version = y[1]), f && (a.webos = !0, a.version = f[2]), _ && (a.touchpad = !0), S && (a.blackberry = !0, a.version = S[2]), b && (a.bb10 = !0, a.version = b[2]), T && (a.rimtabletos = !0, a.version = T[2]), x && (s.playbook = !0), g && (a.kindle = !0, a.version = g[1]), m && (s.silk = !0, s.version = m[1]), !m && a.android && e.match(/Kindle Fire/) && (s.silk = !0), E && (s.chrome = !0, s.version = E[1]), w && (s.firefox = !0, s.version = w[1]), P && (a.firefoxos = !0, a.version = P[1]), C && (s.ie = !0, s.version = C[1]), I && (u || a.ios || v || c) && (s.safari = !0, a.ios || (s.version = I[1])), k && (s.webview = !0), u) {
				...
				a.tablet = !!(d || x || c && !e.match(/Mobile/) || w && e.match(/Tablet/) || C && !e.match(/Phone/) && e.match(/Touch/)), a.phone = !(a.tablet || a.ipod || !(c || h || f || S || b || E && e.match(/Android/) || E && e.match(/CriOS\/([\d.]+)/) || w && e.match(/Mobile/) || C && e.match(/Touch/))), a.pc = !a.tablet && !a.phone, u ? a.name = "macOS" : v ? (a.name = "windows", a.version = (n = navigator.userAgent, o = "", (-1 < n.indexOf("Windows NT 5.0") || -1 < n.indexOf("Windows 2000")) && (o = "2000"), (-1 < n.indexOf("Windows NT 5.1") || -1 < n.indexOf("Windows XP")) && (o = "XP"), (-1 < n.indexOf("Windows NT 5.2") || -1 < n.indexOf("Windows 2003")) && (o = "2003"), (-1 < n.indexOf("Windows NT 6.0") || -1 < n.indexOf("Windows Vista")) && (o = "Vista"), (-1 < n.indexOf("Windows NT 6.1") || -1 < n.indexOf("Windows 7")) && (o = "7"), (-1 < n.indexOf("Windows NT 6.2") || -1 < n.indexOf("Windows 8")) && (o = "8"), (-1 < n.indexOf("Windows NT 6.3") || -1 < n.indexOf("Windows 8.1")) && (o = "8.1"), (-1 < n.indexOf("Windows NT 10") || -1 < n.indexOf("Windows 10")) && (o = "10"), o)) : a.name = function() {
					...
					return n && (t = "macOS"), "X11" != navigator.platform || r || n || (t = "Unix"), -1 < String(navigator.platform).indexOf("Linux") && (t = "Linux"), r ? "windows" : t
				}(), s.name = (i = navigator.userAgent.toLowerCase(), (r = D.exports.browser).firefox ? "Firefox" : r.ie ? /edge/.test(i) ? "Edge" : "IE" : /micromessenger/.test(i) ? "寰俊鍐呯疆娴忚鍣�" : /qqbrowser/.test(i) ? "QQ娴忚鍣�" : r.webview ? "webview" : r.chrome ? "Chrome" : r.safari ? "Safari" : /baiduspider/.test(i) ? "Baiduspider" : /ucweb/.test(i) || /UCBrowser/.test(i) ? "UC" : /opera/.test(i) ? "Opera" : /ucweb/.test(i) ? "UC" : /360se/.test(i) ? "360娴忚鍣�" : /bidubrowser/.test(i) ? "鐧惧害娴忚鍣�" : /metasr/.test(i) ? "鎼滅嫍娴忚鍣�" : /lbbrowser/.test(i) ? "鐚庤惫娴忚鍣�" : /playstation/.test(i) ? "PS4娴忚鍣�" : void 0)
	...
	39: [function(e, t, i) {
		...
		t.exports.getAbsoluteURL = function(e) {
			...
			var t, i, r, n, o;
			n = ["protocol", "hostname", "port", "pathname", "search", "hash", "host"], (r = "" === (i = s.createEl("a", {
				href: e
			})).host && "file:" !== i.protocol) && ((t = s.createEl("div")).innerHTML = '<a href="' + e + '"></a>', i = t.firstChild, t.setAttribute("style", "display:none; position:absolute;"), document.body.appendChild(t)), o = {};
			for(var a = 0; a < n.length; a++) o[n[a]] = i[n[a]];
			return o.segments = i.pathname.replace(/^\//, "").split("/"), r && document.body.removeChild(t), o
		}
	}, {
		"./dom": 24
	}],
	40: [function(e, r, t) {
		...
		r.exports.formatTime = function(e) {
			...
			return t = Math.floor(n / 3600), n %= 3600, i = Math.floor(n / 60), r = n % 60, !(t === 1 / 0 || isNaN(t) || i === 1 / 0 || isNaN(i) || r === 1 / 0 || isNaN(r)) && ("00" === (t = 10 <= t ? t : "0" + t) ? "" : t + ":") + (i = 10 <= i ? i : "0" + i) + ":" + (r = 10 <= r ? r : "0" + r)
			...
			var t = e.split(":"),
				...
				r = 0,
				n = 0;
			return 3 === t.length ? (i = t[0], r = t[1], n = t[2]) : 2 === t.length ? (r = t[0], n = t[1]) : 1 === t.length && (n = t[0]), 3600 * (i = parseInt(i, 10)) + 60 * (r = parseInt(r, 10)) + (n = Math.ceil(parseFloat(n)))
			...
			return 2 !== (i = (e = decodeURIComponent(e)).split("?")).length ? {} : (o = i[1], (t = o.split("&")) ? (r = {}, n = 0, $(t).each(function() {
				var e;
				2 === (e = t[n].split("=")).length && (r[e[0]] = e[1].replace(/\+/g, " ")), n++
			}), r) : {})
		...
		function p(t, e, a) {
			...
			t = t.substr(3), n(), e.endTime = r(), n(),
				function(e, t) {
					...
					c(e, function(e, t) {
						switch(e) {
							...
							case "line":
								var r = t.split(","),
									n = r[0];
								o.integer(e, n), o.percent(e, n) && o.set("snapToLines", !1), o.alt(e, n, ["auto"]), 2 === r.length && o.alt("lineAlign", r[1], ["start", d, "end"]);
								break;
							case "position":
								r = t.split(","), o.percent(e, r[0]), 2 === r.length && o.alt("positionAlign", r[1], ["start", d, "end", "line-left", "line-right", "auto"]);
								break;
							case "size":
								o.percent(e, t);
								break;
					...
					"auto" === i && -1 === u.line && (i = -1), t.line = i, t.lineAlign = o.get("lineAlign", "start"), t.snapToLines = o.get("snapToLines", !0), t.size = o.get("size", 100), t.align = o.get("align", d);
					var r = o.get("position", "auto");
					"auto" === r && 50 === u.position && (r = "start" === t.align || "left" === t.align ? 0 : "end" === t.align || "right" === t.align ? 100 : 50), t.position = r
				}(t, e)
		}
		n.prototype = {
			parse: function(e) {
	...
	44: [function(e, t, i) {
		var r, n = e("../lib/oo"),
			...
			l = n.extend({
				init: function(e, t, i) {
					void 0 === i && (i = !0), this.trackLog = i, this.player = e, this.requestId = "", this.sessionId = T.guid(), this.playId = 0, this.firstPlay = !0, this.osName = E.os.name, this.osVersion = E.os.version || "", this.exName = E.browser.name, this.exVersion = E.browser.version || "";
					...
					try {
						...
						! function(t) {
							if(S.trackLog) x.jsonp("https://cdn.dns-detect.alicdn.com/api/cdnDetectHttps?method=createDetectHttps", function(e) {
								if(e.content) return x.jsonp(e.content, t, b)
							}, b)
						}(function(e) {
							e && e.content && (_ = S._userNetInfo.cdnIp = e.content.ldns, g = S._userNetInfo.localIp = e.content.localIp, S._log("FETCHEDIP", {
								cdn_ip: _,
								local_ip: g
							}))
						})
				...
				bindEvent: function() {
					...
					this.player.on(a.Player.Init, function() {
						...
						t.loadstartTime = (new Date).getTime(), t._onPlayerloadstart()
				...
				removeEvent: function() {
					this.player.off("init"), this.player.off("ready"), this.player.off("ended"), this.player.off("play"), this.player.off("pause"), this.player.off("seekStart"), this.player.off("seekEnd"), this.player.off("canplaythrough"), this.player.off("error"), this.player.off("fullscreenchange"), clearInterval(r)
				},
				_onFullscreenChange: function(e) {
					e ? this._log("FULLSREEM", {}) : this._log("QUITFULLSCREEM", {})
				},
				_onPlayerloadstart: function() {
					this.playId = T.guid(), this._log("LOADSTART", {
						pt: (new Date).getTime()
					})
				},
				...
				_onPlayerLoaddata: function() {
					this._LoadedData = !0, this._log("LOADEDDATA", {
						cost: (new Date).getTime() - this.loadstartTime
					}), this._reportPlay()
				},
				...
				_onPlayerFinish: function() {
					this._log("STOP", {
						vt: Math.floor(1e3 * this.player.getCurrentTime())
					}), this.sessionId = T.guid(), this.playId = 0
				},
				...
				_onPlayerPlay: function() {
					this._log("STARTPLAY", {}), 0 == this.playId && (this.playId = T.guid()), this.firstPlay || 0 != this.pause_flag || this.seeking || (this.sessionId = T.guid()), this.firstPlay = !1, this._reportPlay() || this.buffer_flag && this.pause_flag && (this.pause_flag = 0, this.pauseEndTime = (new Date).getTime(), this._log("RECOVER", {
						vt: Math.floor(1e3 * this.player.getCurrentTime()),
				...
				_onPlayerSeekStart: function(e) {
					this.seekStartTime = e.paramData.fromTime, this.seeking = !0, this.seekStartStamp = (new Date).getTime()
				},
				...
				_onPlayerUnderload: function() {
					if(!this.buffer_flag && this.player._options && !this.player._options.autoplay) return this.first_play_time = (new Date).getTime(), this._log("PLAY", {
						play_mode: "fix",
						vt: 0,
						start_cost: this.first_play_time - this.player.getReadyTime()
				...
				_log: function(e, t) {
					if(this.trackLog) {
						...
						if(this.requestId = T.guid(), "ERROR" == e && "FETCHEDIP" != e && "CDNDETECT" != e) {
							var r = this;
						...
						l && l.vid && (s = l.vid), a.push("vid=" + s);
						try {
							Aliplayer && Aliplayer.__logCallback__ && (i.args = a, Aliplayer.__logCallback__(i))
						} catch(e) {
							console.log(e)
						}
						"" == (a = a.join("&")) && (a = "0"), i.args = encodeURIComponent(a);
						var c = [];
						return u.each(i, function(e, t) {
							c.push(e + "=" + t)
						}), c = c.join("&"), x.jsonp(n + "?" + c, function() {}, function() {}), this.sessionId
					}
				},
				_getUuid: function() {
					var e = o.get("p_h5_u");
					return e || (e = T.guid(), o.set("p_h5_u", e, 730)), e
				}
			});
		t.exports = l
	}, {
	...
	45: [function(e, t, i) {
		...
		t.exports.create = function(e, t) {
			"function" != typeof t && (t = function() {}), e.readyCallback = t, g.setCurrentLanguage(e.language, "h5", e.languageTexts);
			var i = _.handleOption(e),
				r = i.source,
				n = _.isAudio(r);
			n && (i.height = "auto", i.mediaType = "audio");
			var o, a = _.createWrapper(i);
			return a.player ? a.player : (n ? o = new p(a, i) : !i.useFlashPrism && _.isFlv(r) && _.isSupportFlv() ? o = new f(a, i) : y.IS_MOBILE || !i.useFlashPrism && !_.isRTMP(r) ? i.vid && !i.source ? o = i.authInfo ? new c(a, i) : i.playauth || i.accessKeyId && i.accessKeySecret ? new u(a, i) : new d(a, i) : _.isDash(r) && _.isSupportMSE() ? o = new v(a, i) : _.isHls(r) ? _.canPlayHls() ? o = _.isSupportHls() && (_.isUsedHlsPluginOnMobile() || _.isSafariUsedHlsPlugin(i.useHlsPluginForSafari)) ? new h(a, i) : new s(a, i) : _.isSupportHls() ? o = new h(a, i) : y.os.pc ? i.userH5Prism || i.useH5Prism || (o = new l(a, i)) : o = new s(a, i) : o = (y.os.pc, new s(a, i)) : o = new l(a, i), o)
		}
	}, {
		"../lang/index": 17,
		"../lib/dom": 24,
	...
	50: [function(e, t, i) {
		...
		t.exports.handle = function(e) {
			e.paramData.notPlay || this.play(), this._seeking = !1, this.trigger(r.Player.CompleteSeek, e.paramData.toTime)
		}
	}, {
		"../../event/eventtype": 48
	}],
	...
	59: [function(e, t, i) {
		...
		t.exports.handle = function(e) {
			var t = this;
			t.waiting = !1, t._options.rePlay ? (t.seek(0), t.tag.play()) : t._options.isLive && t.trigger(r.Private.H5_Loading_Hide), t.trigger(r.Player.Ended)
		}
	}, {
		"../../../../lang/index": 17,
		"../../event/eventtype": 48
		...
		t.exports.handle = function(e) {
			...
			if(t.waiting = !1, t._clearTimeout(), t.checkOnline()) {
				var i, r = "",
					...
					o = n.error.message;
				r = "";
				if(n.error.code && (i = n.error.code, r = d.VideoErrorCode[n.error.code], o = i + " || " + o), t._options.isLive) t._options.liveRetry > t._liveRetryCount ? t._reloadAndPlayForM3u8() : (t._liveRetryCount = 0, t.trigger(u.Player.LiveStreamStop), t._liveErrorHandle = setTimeout(function() {
					var e = {
						mediaId: "ISLIVE",
						error_code: r,
						error_msg: p.get("Error_Play_Text") + "锛�" + p.get("Error_Retry_Text")
					};
					...
					} else t._eventState == d.SUSPEND ? (a = p.get("Error_Load_Abort_Text"), r = d.ErrorCode.RequestDataError) : t._eventState == d.LOAD_START ? (a = p.get("Error_Network_Text"), 0 < t._options.source.indexOf("auth_key") && (a = a + "锛�" + p.get("Error_AuthKey_Text")), r = d.ErrorCode.StartLoadData) : t._eventState == d.LOADED_METADATA && (a = p.get("Error_Play_Text"), r = d.ErrorCode.PlayingError);
					a = a + "锛�" + p.get("Error_Retry_Text"), 1 < t._urls.length && t._retrySwitchUrlCount < 3 && -1 == t._options.source.indexOf(".mpd") && (t.switchUrl(), s = !0);
					var c = {
						mediaId: t._options.vid ? t._options.vid : "",
						error_code: r,
						error_msg: o
					};
					t.logError(c), c.display_msg = a, s || t.trigger(u.Player.Error, c)
				}
			}
		}
	}, {
	...
	61: [function(e, t, i) {
		var n = e("../../../../lib/event"),
			...
			a = function(t, i, r) {
				var e = t.tag;
				n.on(e, i, function(e) {
					r.handle.call(t, e, i), i != o.Video.Error && (i == o.Video.ManualEnded && (i = o.Video.Ended), t.trigger(o.Private.LifeCycleChanged, {
						type: i,
						data: e
					}))
				})
	...
	62: [function(e, t, i) {
		var r = e("../../event/eventtype");
		t.exports.handle = function(e) {
			this._clearTimeout(), this.trigger(r.Private.AutoStreamHide), this.trigger(r.Player.Pause), this.waiting = !1
		}
	}, {
		"../../event/eventtype": 48
	}],
	...
	64: [function(e, t, i) {
		...
		t.exports.handle = function(e) {
			...
			if(t.trigger(r.Private.H5_Loading_Hide), t.trigger(r.Private.Cover_Hide), t.trigger(r.Private.Info_Hide), t.waiting = !1, t._liveRetryCount = 0, t._firstDecodeError = !0, t._checkTimeoutHandle && (clearTimeout(t._checkTimeoutHandle), t._checkTimeoutHandle = null), t._waitingTimeoutHandle && (clearTimeout(t._waitingTimeoutHandle), t._waitingTimeoutHandle = null, t._ccService && t._options.isLive)) {
				...
				t._setDefaultCC = !0, i && t._ccService["switch"](i)
			}
			t.trigger(r.Private.AutoStreamHide), t.trigger(r.Player.Playing), t.trigger(r.Private.Play_Btn_Hide), t.trigger(r.Private.Error_Hide)
		}
	}, {
		"../../event/eventtype": 48
	}],
	65: [function(e, t, i) {
		...
		t.exports.handle = function(e) {
			...
			(t.waiting && !t._TimeUpdateStamp && (t._TimeUpdateStamp = i), 0 != t.waiting && t._TimeUpdateStamp == i || (t.trigger(r.Private.H5_Loading_Hide), t.trigger(r.Private.AutoStreamHide), t._checkTimeoutHandle && clearTimeout(t._checkTimeoutHandle), t._waitingTimeoutHandle && clearTimeout(t._waitingTimeoutHandle), t.waiting = !1), t._TimeUpdateStamp = i, t._options.isLive) || this.getDuration() < i && (t.pause(), Event.trigger(this.tag, EventType.Video.ManualEnded))
		}
	}, {
		"../../event/eventtype": 48
	}],
	66: [function(e, t, i) {
		...
		t.exports.handle = function(e) {
			...
			if(!t._options.isLive) {
				var i = this.getCurrentTime(),
					r = this.getDuration();
				if(r - i < .2 || r < i) return t.pause(), void s.trigger(this.tag, o.Video.ManualEnded)
			}
			t.trigger(o.Private.H5_Loading_Show), t.waiting = !0;
			var n = function() {
				t._checkTimeoutHandle && clearTimeout(t._checkTimeoutHandle), t._waitingTimeoutHandle && clearTimeout(t._waitingTimeoutHandle)
			};
			n(), t._TimeUpdateStamp = null, t._checkTimeoutHandle = setTimeout(function() {
			...
			}, 1e3 * t._options.waitingTimeout), t.on("error", function() {
				n()
			})
		}
	}, {
	...
	67: [function(e, t, i) {
		var o = e("../../ui/component"),
			...
			E = o.extend({
				init: function(e, t) {
					if(this.tag = e, this.loaded = !1, this.played = !1, this.waiting = !1, this._urls = [], this._currentPlayIndex = 0, this._retrySwitchUrlCount = 0, this._isError = !1, this._isHls = !1, this._liveRetryCount = 0, this._seeking = !1, this._serverRequestId = 0, this._created = !1, this._firstDecodeError = !0, this._liveShiftSeekStartTime = 0, this.__disposed = !1, void 0 === t.skinLayout && (t.skinLayout = p.defaultH5Layout), o.call(this, this, t), this.addClass("prism-player"), t.plugins && a.each(t.plugins, function(e, t) {
							this[e](t)
						}, this), this._createService(), this.UI = {}, t.useNativeControls ? this.tag.setAttribute("controls", "controls") : this.UI = l, this.initChildren(), _.onAll(this), this._lifeCycleManager = new T(this), this._options.trackLog && (this._monitor = new c(this, {
							video_id: 0,
							album_id: 0,
						...
						if(this._overrideNativePlay(), !this._liveshiftService || this._liveshiftService.validate()) {
							if(this._extraMultiSources(), this._options.source)
								if(this._options.autoPlayDelay) {
		...
		E.prototype.initPlay = function(e) {
			...
			!1 !== t && 0 !== t.length && (this.options({
				children: t
			}), o.prototype.initChildren.call(this)), e.preload || e.autoplay || (this.UI.cover = g, this.addChild("cover", e)), this.UI.playanimation = m, this.addChild("playanimation", e), this.UI.autoStreamSelector = S, this.addChild("autoStreamSelector", e), this.trigger(b.Private.UiH5Ready)
			...
			}), this.setVideoAttrs(), e || (i.parentNode && i.parentNode.insertBefore(t, i), n.insertFirst(i, t)), t
			...
			if(0 == navigator.onLine) {
				...
				return this.logError(e), e.display_msg = v.get("Error_Offline_Text"), this.trigger(b.Player.Error, e), !1
			}
			return !0
		}, E.prototype.id = function() {
			return this.el().id
		}, E.prototype.renderUI = function() {}, E.prototype.switchUrl = function() {
			if(0 != this._urls.length) {
				...
				f.set(u.SelectedStreamLevel, e.definition, 365), this.trigger(b.Private.QualityChange, v.get("Quality_Change_Fail_Switch_Text"));
				this.getCurrentTime();
				this._options.source = e.Url, this.tag.setAttribute("src", this._options.source), this.tag.play()
			}
			...
			i = window.setInterval(function(e) {
				if(t.tag) {
					if(0 < r.readyState) {
						...
						t.trigger(b.Private.ReadyState), clearInterval(i)
					}
			...
			if(this.tag) {
				(this._options.preload || this.loaded) && this.tag.src || this._initLoad(this._options.source), this.trigger(b.Private.Cover_Hide), this.tag.play()
			}
			return this
		}, E.prototype.replay = function() {
			return this.seek(0), this.tag.play(), this
		}, E.prototype.pause = function() {
			return this.tag && this.tag.pause(), this
			...
			var e = 0;
			return this.tag && (e = this.tag.duration), e
			...
			this._clearTimeout(), this._options.vid = 0, this._options.source = e, this._monitor && this._monitor.updateVideoInfo({
				...
				source: e,
				from: this._options.from
			}), this.trigger(b.Private.ChangeURL), this.initPlay(), (this._options.preload || this._options.autoplay) && this.trigger(b.Private.Cover_Hide), this._options.autoplay ? this.trigger(b.Player.Play) : this.trigger(b.Player.Pause), t || (t = 0), !t && 0 != t || isNaN(t) || this.seek(t)
		}, E.prototype._loadByUrlInner = function(e, t, i) {
			this.loadByUrl(e, t, i, !0)
		}, E.prototype.loadByUrl = function(e, t, i, r) {
			this._clearTimeout(), this.trigger(b.Private.Error_Hide), this._options.vid = 0, this._options.source = e, this._monitor && this._monitor.updateVideoInfo({
				video_id: 0,
				album_id: 0,
				source: e,
				from: this._options.from
			}), r || this.trigger(b.Private.ChangeURL), this._options._autoplay = i, this.initPlay(i), (this._options.preload || this._options.autoplay) && this.trigger(b.Private.Cover_Hide), this._options.autoplay || i ? this.trigger(b.Player.Play) : this.trigger(b.Player.Pause);
			var n = this;
			this._options.isLive || s.one(this.tag, b.Video.CanPlay, function(e) {
				!t && 0 != t || isNaN(t) || n.seek(t)
			})
		}, E.prototype.dispose = function() {
			this.__disposed = !0, this.trigger(b.Private.Dispose), this.tag.pause(), _.offAll(this), this._monitor && (this._monitor.removeEvent(), this._monitor = null), this._autoPlayDelay && this._autoPlayDelay.dispose(), this._checkTimeoutHandle && clearTimeout(this._checkTimeoutHandle), this._waitingTimeoutHandle && clearTimeout(this._waitingTimeoutHandle), this._disposeService(), this._clearLiveErrorHandle(), this._el.innerHTML = "", this.destroy(), this.tag = null, this._options.recreatePlayer = null, this._options = null
			...
			if(this._aiLabelService) {
				var e = this;
				this.trigger(b.Private.H5_Loading_Show), this.trigger(b.Private.Play_Btn_Hide), this.one("canplay", function() {
			...
			if(!p.validateSource(t)) {
				...
				return this.logError(i), i.display_msg = v.get("Error_Invalidate_Source"), this.trigger(b.Player.Error, i), !1
			}
			return this.trigger(b.Private.H5_Loading_Hide), void 0 === e && (e = !1), this._created || (this._created = !0, this.trigger(b.Private.Created)), this.loaded || this.trigger(b.Player.Init), (this._options.autoplay || this._options.preload || e) && (this._initLoad(t), this._options.autoplay || this._options._autoplay ? this._startPlay() : this.trigger(b.Private.Play_Btn_Show)), !0
		}, E.prototype._initLoad = function(e) {
			this._options.autoplay && this.trigger(b.Private.H5_Loading_Show), this.getMetaData(), e && this.tag.setAttribute("src", e), this.loaded = !0
			...
			var e = this._options.source,
				t = "";
			if(0 < e.indexOf("m3u8") ? "" != this.tag.canPlayType("application/x-mpegURL") || p.isSupportHls() || (t = v.get("Error_Not_Support_M3U8_Text")) : 0 < e.indexOf("mp4") ? "" == this.tag.canPlayType("video/mp4") && (t = v.get("Error_Not_Support_MP4_Text")) : (p.isRTMP(e) || p.isFlv(e)) && r.IS_MOBILE && (t = v.get("Error_Not_Support_Format_On_Mobile")), t) {
				var i = {
					mediaId: this._options.vid ? this._options.vid : "",
			...
			e || (e = {}), e.vt = this.getCurrentTime(), this._serverRequestId = this.log("ERROR", e)
			...
			this.tag.play = function() {
				if(!n._options.source) {
					...
					return e.display_msg = v.get("Error_Invalidate_Source"), void n.trigger(b.Player.Error, e)
				}
				n.readyTime = (new Date).getTime();
				var t = r.apply(n.tag);
				void 0 !== t && t["catch"](function(e) {
					n.trigger(b.Private.Play_Btn_Show), n.trigger(b.Private.H5_Loading_Hide), n.trigger(b.Player.AutoPlayPrevented)
				}).then(function() {});
			...
			if(e && -1 < e.indexOf("{") && -1 < e.indexOf("}")) {
				...
				try {
					...
					console.error(e), console.error("鍦板潃json涓叉牸寮忎笉瀵�")
				}
				var i = [];
				for(var r in t) {
				...
				if(0 < i.length) {
					...
					this._urls = i, this._options.source = o.Url, this.trigger(b.Private.SourceLoaded, o)
				}
			}
				...
				if(e && u.isArray(e) && 0 < e.length)
					for(var i = 0; i < e.length; i++) {
						...
						var s = new(Function.prototype.bind.apply(n, o)),
							l = s[p.createEl];
						l && "function" == typeof l && l.call(s, t.el()), this.components.push({
							name: a,
							obj: s
						})
					}
		...
		var h = function(e, t) {
				if(t) {
					var i, r = t.paramData,
						n = r.type,
						o = r.data;
					((i = n) == d.Video.LoadStart || i == d.Video.LoadedData || i == d.Video.LoadedMetadata) && (n = p.loading), f(e, n);
	...
	72: [function(e, t, i) {
		var r = e("../../lib/ua"),
			...
			o = function(e, t) {
				...
				t ? (height = n, width = o) : (height = i.indexOf("%") ? i : i + "px", width = r.indexOf("%") ? r : r + "px"), e.tag.style.width = o, e.tag.style.height = n, e.el().style.height = t ? n : height
			};
		t.exports.isAndroidX5 = function() {
			...
			r.os.android && r.is_X5 && ("h5" == e._options.x5_type && (e.tag.setAttribute("x5-video-player-type", e._options.x5_type), window.onresize = function() {
				...
				o(e, e._options.x5_fullscreen || "center" == e._options.x5_video_position), e.trigger("x5requestFullScreen")
				...
				}(e), e.trigger("x5cancelFullScreen")
			}), e.on("requestFullScreen", function() {
				"top" == e._options.x5_video_position && n.removeClass(e.tag, "x5-top-left"), r.os.android && r.is_X5 && e._options.x5LandscapeAsFullScreen && (e.tag.setAttribute("x5-video-orientation", "landscape"), e._x5VideoOrientation = "landscape")
			}), e.on("cancelFullScreen", function() {
				"top" == e._options.x5_video_position && n.addClass(e.tag, "x5-top-left"), r.os.android && r.is_X5 && e._options.x5LandscapeAsFullScreen && (e.tag.setAttribute("x5-video-orientation", "portrait"), o(e, e._options.x5_fullscreen || "center" == e._options.x5_video_position), e._x5VideoOrientation = "portrait")
		...
		t.exports.inject = function(e, t, i, r, o, n, a) {
			...
			if(n || (l = s, !e._drm && v.isDash(l))) {
				...
				t.prototype._checkDrmReady = function() {
					...
					this._checkDrmReady();
					if(this.trigger(_.Private.Cover_Hide), this.tag.ended) this.replay();
					else {
						this.getCurrentTime();
					...
					return this._checkDrmReady(), this.tag.pause(), this
					...
					if(f.contentProtocolMixed(s)) {
						...
						return t.display_msg = y.get("Request_Block_Text"), void this.trigger(_.Player.Error, t)
					}

					function i(i, r) {
						var n = function(e) {
							if(!e || i.__support && i.__support.drm[e]) ! function() {
								c(i, i._drm);
								var e = {
									drm: {
								...
								h.DRMKeySystem[4] && (e.drm.servers[h.DRMKeySystem[5]] = "https://foo.bar/drm/widevine", e.drm.servers[h.DRMKeySystem[4]] = "https://foo.bar/drm/playready"), i._drm.configure(e), o && o(i._drm), i._drm.load(i._options.source).then(function() {
									i._initPlayBehavior(r), console.log("The video has now been loaded!")
								})["catch"](function(e) {
									u(i, e)
								})
							}();
					...
					}(that = this)._isLoadedDrm ? i(this, e) : (this.trigger(_.Private.H5_Loading_Show), function(e) {
						...
						this.trigger(_.Private.H5_Loading_Hide), this._isLoadedDrm = !0, i(this, e), this._options.readyCallback(this)
					}))
				...
				}, t.prototype._executeReadyCallback = function() {}, t.prototype.dispose = function() {
			...
			function u(t, i) {
				...
				! function() {
					if(setTimeout(function() {
						...
						t.logError(e), e.display_msg = i.code + "|" + r, t.trigger(_.Player.Error, e)
					}
				}()
			}
		}
	...
	74: [function(e, t, i) {
		var r = e("../base/player"),
			...
			o = r.extend({
				init: function(e, t) {
					n.inject(this, o, r.prototype, t, function(e) {}), r.call(this, e, t)
				}
			});
		t.exports = o
	}, {
	...
	75: [function(e, t, i) {
		var n = e("../../ui/component"),
			...
			m = n.extend({
				init: function(e, t) {
					if(void 0 === t.skinLayout && (t.skinLayout = p.defaultFlashLayout), n.call(this, this, t), this._id = "prism-player-" + o.guid(), this.tag = e, this._el = this.tag, this._childrenUI = [f, v], this.initChildren(), this.id = this._id, window[this.id] = this, d.setCurrentLanguage(this._options.language, "flash", this._options.languageTexts), h.openInFile()) {
						var i = {
							mediaId: this._options.vid ? this._options.vid : "",
					...
					} else if(s.IS_MOBILE) this.trigger(_.Private.Error_Show, {
						mediaId: this._options.vid ? this._options.vid : "",
						error_code: a.ErrorCode.FormatNotSupport,
						...
						if(this._options.vid && this._options.accessKeyId && this._options.securityToken && this._options.accessKeySecret) {
							...
							g.getPlayAuth(this._options, function(e) {
								...
								e.sri && (t.sri = e.sri), t.display_msg = e.display_msg, r.trigger(_.Private.Error_Show, t)
							}, "flash")
				...
				_createPlayer: function() {
					if(this._options.autoPlayDelay) {
						var e = new r(this),
							t = this;
						e.handle(function() {
							t._options.autoplay = !0, t._initPlayer(), t._childrenUI.push(y), t.initChildren()
						})
					} else this._initPlayer(), this._childrenUI.push(y), this.initChildren()
				},
				...
				onPlay: function() {
					this._status = "play", this.trigger("play"), this._clearTimeoutHandle(), this.trigger(_.Private.AutoStreamHide)
				},
				onEnded: function() {
					this._clearTimeoutHandle(), this._status = "ended", this.trigger("ended")
				},
				onPause: function() {
					this._status = "pause", this._clearTimeoutHandle(), this.trigger(_.Private.AutoStreamHide), this.trigger("pause")
				},
				...
				_invoke: function() {
					var e = arguments[0],
						t = arguments;
					if(Array.prototype.shift.call(t), !this.flashPlayer) throw new Error("PrismPlayer Error: flash player is not ready锛宲lease use api after ready event occured!");
			...
			if(n || (s = o, !e._flv && u.isFlv(s))) {
				...
				e._Type = t, e._superType = i, e._superPt = i.prototype, e._disposed = !1, t.prototype._checkFlvReady = function() {
					...
					if(this.trigger(y.Private.Cover_Hide), this._options.isLive && e) this._loadByUrlInner(this._options.source, 0, e);
						...
						if(0 == this._seeking) {
							var t = 0;
							this.tag.ended || (t = this.getCurrentTime()), this.seek(t)
						}
						this.tag.paused && (this._hasLoaded || (this.getMetaData(), this._flv.load()), this._flv.play())
					}
					return this
				}, t.prototype.replay = function() {
					return this._checkFlvReady(), this._loadByUrlInner(this._options.source, 0, !0), this
					...
					var e = this._flv.getFirstSample(),
						t = e && e.pts ? e.pts : 0;
					return console.log("鎺ㄦ祦鏃堕棿锛�" + this._metadata.NtpTime), console.log("棣栧抚PTS锛�" + t), this._metadata.NtpTime + t
				}, t.prototype.initPlay = function(e) {
					if(f.browser.safari && this.trigger(y.Private.Snapshot_Hide), h.contentProtocolMixed(o)) {
						...
						return t.display_msg = v.get("Request_Block_Text"), void this.trigger(y.Player.Error, t)
					}
					...
					function i(t, e) {
						...
						for(var o in i ? (r.enableStashBuffer = t._options.enableStashBufferForFlv, stashInitialSize = t._options.stashInitialSizeForFlv, r.autoCleanupSourceBuffer = !1) : r.lazyLoadMaxDuration = 600, t._options.flvOption) "cors" == o || "hasAudio" == o || "withCredentials" == o || "hasVideo" == o || "type" == o ? n[o] = t._options.flvOption[o] : r[o] = t._options.flvOption[o];
						t._originalUrl = t._options.source, t._flv = flvjs.createPlayer(n, r), l(t, t._flv), t._flv.on(flvjs.Events.MEDIA_INFO, function(e) {
							t._metadata = e.metadata
						}), t._flv.attachMediaElement(t.tag), t._initPlayBehavior(e) && ((t._options.preload || t._options.autoplay) && (t._hasLoaded = !0, t._flv.load()), t._options.autoplay && !t.tag.paused && t._flv.play(), a && a(t._flv))
						...
						this.trigger(y.Private.H5_Loading_Hide), this._isLoadedFlv = !0, i(that, e), this._options.readyCallback(this)
					}, this._options.debug))
					...
					this._disposed || (this._disposed = !0, this._superPt && this._superPt.dispose.call(this), this._destroyFlv(), this._superPt && (t.prototype.play = this._superPt.play, t.prototype.pause = this._superPt.pause, t.prototype.initPlay = this._superPt.initPlay, t.prototype.replay = this._superPt.replay, t.prototype.seek = this._superPt.seek, t.prototype.canSeekable = this._superPt.canSeekable, t.prototype._executeReadyCallback = this._superPt._executeReadyCallback))
					...
					e.on(flvjs.Events.ERROR, function(e, t, i) {
						...
						var a = function() {
							if(setTimeout(function() {
								...
								c.logError(e), e.display_msg = n, d.cityBrain && (c.flv = null), c.trigger(y.Player.Error, e)
							}
						};
						if(c._options && c._options.isLive && !u) {
							...
							if(s.liveRetry > c._liveRetryCount) {
								...
								c._liveRetryCount++, h.sleep(1e3 * l), c._loadByUrlInner(s.source)
							} else c.trigger(y.Player.LiveStreamStop), c._liveErrorHandle = setTimeout(a, 500)
						} else a()
					})
				}
			}
	...
	77: [function(e, t, i) {
		var r = e("../base/player"),
			...
			o = r.extend({
				init: function(e, t) {
					n.inject(this, o, r, t, function(e) {}), r.call(this, e, t)
				}
			});
		t.exports = o
	}, {
	...
	78: [function(e, t, i) {
		...
		t.exports.inject = function(e, t, i, r, n, o) {
			...
			if(o || (l = a, c = s, !e._hls && v.isHls(l) && (!v.canPlayHls() || v.isSafariUsedHlsPlugin(c) || v.isUsedHlsPluginOnMobile()))) {
				...
				e._Type = t, e._superType = i, e._superPt = i.prototype, e._disposed = !1, t.prototype._checkHlsReady = function() {
				...
				}, e._isHls = !0, e._hls = null, e._isLoadedHls = !1, t.prototype.play = function() {
					this._checkHlsReady();
					if(this.trigger(_.Private.Cover_Hide), this._options.autoplay || this._options.preload || this._loadSourced || (this._loadSourced = !0, this._hls.loadSource(this._options.source)), this.tag.ended) this.replay();
					...
					return this.tag && (this._checkHlsReady(), this.tag.pause(), this._hls.stopLoad()), this
				}, t.prototype.stop = function() {
					return this._checkHlsReady(), this.tag.setAttribute("src", null), this._hls.stopLoad(), this
				}, t.prototype.seek = function(e) {
					this._checkHlsReady();
					try {
						this._superPt.seek.call(this, e), this.tag.paused && this._hls.startLoad(e)
					} catch(e) {
						console.log(e)
					}
					return this
					...
					function i(a, e) {
						...
						for(var r in i && (t.manifestLoadingTimeOut = i, t.levelLoadingTimeOut = i, t.fragLoadingTimeOut = i), a._options.nudgeMaxRetry && (t.nudgeMaxRetry = a._options.nudgeMaxRetry), a._options.maxMaxBufferLength && (t.maxMaxBufferLength = a._options.maxMaxBufferLength), a._options.maxBufferSize && (t.maxBufferSize = a._options.maxBufferSize), a._options.maxBufferLength && (t.maxBufferLength = a._options.maxBufferLength), t.enableWorker = a._options.enableWorker, t.debug = a._options.debug, a._options.hlsOption) t[r] = a._options.hlsOption[r];
						a._hls = new Hls(t), n && n(a._hls), u(a, a._hls), a._loadSourced = !1, (a._options.autoplay || a._options.preload || e) && (a._loadSourced = !0, a._hls.loadSource(a._options.source)), a._hls.attachMedia(a.tag), a._hls.on(Hls.Events.MANIFEST_PARSED, function() {
							...
							a.trigger(_.Player.AudioTrackSwitch, t), setTimeout(function() {
					...
					this._isLoadedHls ? i(this, e) : (this.trigger(_.Private.H5_Loading_Show), function(e, t) {
						...
						this.trigger(_.Private.H5_Loading_Hide), this._isLoadedHls = !0, i(this, e), this._options.readyCallback(this)
					}, this._options.debug))
				}, t.prototype._executeReadyCallback = function() {}, t.prototype._destroyHls = function() {
					this._hls && this._hls.destroy(), this._hls = null
				}, t.prototype.dispose = function() {
					this._disposed || (this._disposed = !0, this._superPt && this._superPt.dispose.call(this), this._destroyHls(), this._superPt && (t.prototype.play = this._superPt.play, t.prototype.pause = this._superPt.pause, t.prototype.initPlay = this._superPt.initPlay, t.prototype.replay = this._superPt.replay, t.prototype.stop = this._superPt.stop, t.prototype.seek = this._superPt.seek, t.prototype._executeReadyCallback = this._superPt._executeReadyCallback))
				};
				var u = function(l, e) {
						...
						if(l._options && t.details != Hls.ErrorDetails.FRAG_LOOP_LOADING_ERROR && 1 != l._seeking && (0 != t.fatal || t.type == Hls.ErrorTypes.NETWORK_ERROR)) {
							...
							var o = function() {
								if(l.pause(), setTimeout(function() {
									...
									l.logError(e), e.display_msg = r, l.trigger(_.Player.Error, e)
								}
							};
							if(l._options && l._options.isLive) {
								...
								if(a.liveRetry > l._liveRetryCount) {
									...
									l._liveRetryCount++, f.sleep(1e3 * s), n && l._loadByUrlInner(l._options.source, 0, !0)
								} else l.trigger(_.Player.LiveStreamStop), l._liveErrorHandle = setTimeout(o, 500)
							} else o()
						}
					})
				}
		...
		var l = e("../../lib/io"),
			...
			f = function(e, r, n) {
				...
				l.post(a, s, function(e) {
					...
					} else n && n(p.createError("MPS鑾峰彇License澶辫触"))
				}, function(e) {
					if(n) {
						var t = {
							Code: "",
			...
			return l._options.vid && (l.__vid = l._options.vid),
				function(e, i) {
					...
					if(r) {
						...
						if(r.encryptionType == u.EncryptionType.Widevine) n.data = c.encode(e.message);
						else if(r.encryptionType == u.EncryptionType.PlayReady) {
							var o = c.unpackPlayReady(e.message);
							n.data = o.changange, o.header && (n.header = JSON.stringify(o.header))
						}
						console.log(n.data);
						var a = l.__licenseKeys,
							s = l.__vid + r.Url;
						a && a[s], f(n, function(e) {
							l.__licenseKeys || (l.__licenseKeys = {}), 10 < n.data.length && (l.__licenseKeys[s] = e);
							var t = c.decode(e);
							i(t)
						}, function(e) {
							var t = {
		...
		var v = function(e, n) {
				...
				for(var i = e.length, r = 0; r < i; r++) {
					var o = e[r],
						...
						s = "";
					s = void 0 === a ? o.bitrate : t == a ? a + o.bitrate : a, o.desc = s, t = a
				}
			},
			y = function(e, n) {
				var t = "";
				...
				for(var i = e.length, r = 0; r < i; r++) {
					var o = e[r],
						a = u.QualityLevels[o.definition],
						s = "";
					s = void 0 === a ? "" : t == a ? a + o.height : a, o.desc = s, t = a
				}
			};
			...
			c.get(o, function(e) {
				if(e) {
					...
					var o = function(e, t) {
						...
						return 0 < n.length ? (v(n, t), n) : 0 < r.length ? (y(r, t), r) : 0 < i.length ? (y(i, t), i) : (y(o, t), o)
					}(i, a);
					s && s({
				...
				} else l && l(p.createError("MPS鑾峰彇鍙栨暟澶辫触"))
			}, function(e) {
				if(l) {
					var t = {
						Code: "",
	...
	84: [function(e, t, i) {
		var s = e("../base/player"),
			...
			u = e("../flv/flvinjector"),
			d = e("../drm/drminjector"),
			p = (e("../../lib/cookie"), e("../../lang/index")),
			h = e("../../lib/playerutil"),
			f = e("../base/event/eventtype"),
			v = s.extend({
				init: function(e, t) {
					this._authKeyExpiredHandle = new n(this), "mp3" == t.format ? (t.height = "auto", t.mediaType = "audio", s.prototype.createEl = r.prototype.createEl, r.call(this, e, t)) : s.call(this, e, t)
				}
			});
		v.prototype.loadData = function(r, n) {
			...
			var a = this;
			this._urls = [], this._currentPlayIndex = 0, this._retrySwitchUrlCount = 0, this._authKeyExpiredHandle.clearTick(), this.service.getDataByAuthInfo(r, this._options.qualitySort, function(e) {
				if(a.log("COMPLETEFETCHDATA", {
						cost: (new Date).getTime() - o
					}), e.urls && 0 == e.urls.length) a._mtsError_message(a, {
					Code: c.ErrorCode.URLsIsEmpty,
					Message: p.get("Error_Vod_URL_Is_Empty_Text")
				}, "");
				else {
					a._urls = e.urls, a._currentPlayIndex = h.findSelectedStreamLevel(a._urls, r.defaultDefinition);
					var t = e.urls[a._currentPlayIndex],
						i = t.Url;
					a._options.source = i, h.isHls(i) ? l.inject(a, v, s, a._options) : h.isFlv(i) ? u.inject(a, v, s, a._options) : h.isDash(i) ? d.inject(a, v, s, a._options) : a._player._options.readyCallback(a._player), a._authKeyExpiredHandle.tick(c.AuthKeyRefreshExpired), a.trigger(f.Private.SourceLoaded, t), a.initPlay(n), a.trigger(f.Private.ChangeURL), e.thumbnailUrl && a._thumbnailService.get(e.thumbnailUrl)
				}
			}, function(e) {
				a._mtsError_message(a, e, "")
			})
		}, v.prototype._changeStream = function(e, t) {
			this._urls.length > e && (this.loadByUrl(this._urls[e].Url, this.getCurrentTime()), this._currentPlayIndex = e, this.trigger(f.Private.QualityChange, t || p.get("Quality_Change_Fail_Switch_Text")))
			...
			t.sri && (l.sri = t.sri), r.logError(l), l.display_msg = a || p.get("Error_Vod_Fetch_Urls_Text"), r.trigger("error", l), console.log("PrismPlayer Error: " + i + "! error_msg :" + o + ";")
		}, t.exports = v
	}, {
		"../../lang/index": 17,
		"../../lib/constants": 21,
	...
	85: [function(e, u, t) {
		...
		u.exports.randomUUID = function() {
			...
			if(!e) throw new Error("PrismPlayer Error: vid should not be null!");
			return i || (i = "GET"), n.stringify(r(i + "&" + u.exports.AliyunEncodeURI("/") + "&" + u.exports.AliyunEncodeURI(u.exports.makeUTF8sort(e, "=", "&")), t + "&"))
			...
			if(!(e = i.stringify(n.parse(e)))) throw new Error("playuth鍙傛暟瑙ｆ瀽涓虹┖");
			return JSON.parse(e)
		...
		t.exports.getPlayAuth = function(e, i, r, n) {
			...
			l.get(s, function(e) {
				if(e) {
					var t = JSON.parse(e);
					i && i(t.PlayAuth)
				} else r && r(d.createError("鑾峰彇瑙嗛鎾斁鍑瘉澶辫触"))
			}, function(e) {
				if(r) {
					var t = {
						Code: "",
			...
			c.get(l, function(e) {
				if(e) {
					...
					var n = function(e, t) {
						for(var i = [], r = [], n = [], o = [], a = e.length - 1; 0 <= a; a--) {
							var s = e[a],
								l = (u = void 0, (u = {}).width = (c = s).Width, u.height = c.Height, u.definition = c.Definition, u.Url = c.PlayURL, u.format = c.Format, u.desc = p.QualityLevels[u.definition], u);
							"mp4" == l.format ? r.push(l) : "mp3" == l.format ? n.push(l) : "m3u8" == l.format ? i.push(l) : o.push(l)
						}
						var c, u, d = [];
						return d = 0 < n.length ? n : 0 < r.length ? r : 0 < i.length ? i : o, "asc" == t && d.reverse(), d
				...
				} else s && s(d.createError("鐐规挱鏈嶅姟鑾峰彇鍙栨暟澶辫触"))
			}, function(e) {
				if(s) {
					var t = {
						Code: "",
	...
	89: [function(e, t, i) {
		...
		l.prototype.loadByVod = function(e) {
			...
			this.trigger("error_hide"), this._options.source = "", this._options.vid = e, this._options.playauth = t, this.loadByVod(!0)
			...
			} else console.log("涓嶈兘鏇存柊鍦板潃锛寁id鍜屾挱鏀句腑鐨勪笉涓€鑷�")
	...
	90: [function(e, t, i) {
		...
		var r = e("../../ui/component/ai/rect"),
			...
			a = (e("../base/event/eventtype"), function(e, t) {
				this._player = e, this._absoluteDate = t || e._options.ai.startDateTime || 0, this._aiContainer = null, this._aiSetting = [], this._aiRects = [], this._status = "init";
				var i = this;
				this._player.on("pause", function() {
					i.cancel()
					...
					this._aiSetting = [], i._queryStartDate = 0
				});
				var r = function() {
				...
				this._player.on("requestFullScreen", r), this._player.on("cancelFullScreen", r)
			});
		a.prototype.startMeta = function() {
			...
			this._startQueryAiSetting(this._player._options.source, this._absoluteDate, function() {
				var e = function() {
					t._player.paused() && t._player.play(), t.start(), t._player.one("canplay", function() {
						t.__id || t.start()
			...
			if("rectRunning" != this._status) {
				...
				this.__id = requestAnimationFrame(function e() {
					for(var t = 0; t < i._aiRects.length; t++) i._aiRects[t].using = !1;
					(function() {
						...
						if(e && 0 < e.length) {
							...
							for(var o = [], a = 0; a < this._aiRects.length; a++) {
								...
								if(0 == s.using) {
									var l = s.count || 0;
									s.count = l + 1, s.hide(), 5 < l ? this._aiContainer.removeChild(s) : o.push(s)
								} else o.push(s), s.count = 0
							}
							this._aiRects = o.concat(i)
						} else 0 == this._aiSetting.length && this.hideRect()
					}).call(i), "cancel" != i._status && (i.__id = requestAnimationFrame(e))
				})
			}
		}, a.prototype.cancel = function() {
			this._status = "cancel", this.__id && (cancelAnimationFrame(this.__id), this.__id = null), this._cancelQueryAiSetting(), this._currentSettingIndex = 0
			...
			return 0 < n && this._aiSetting.splice(0, n), i
		}, a.prototype._startQueryAiSetting = function(e, c, u) {
			var t, d = this._player._options.ai;
			if(d.boxes) return(t = this)._aiSetting = t._player._options.ai.boxes, void(u && (u(), u = null));
			var p = this,
				i = o.parseUrl(e),
				h = i.segments,
				f = i.hostname,
				v = function() {
					...
					_.log(JSON.stringify(n)), _.log(d.metaQueryUrl);
					var a, s, l;
					a = function(e) {
						if(_.log(e), e) {
							if(u && (u(), u = null), void 0 === e.Code && (e = JSON.parse(e)), !e.Code && e.Content) {
								var t = e.Content.length;
								0 < t && (p._queryStartDate = e.Content[t - 1].timestamp), p._aiSetting = p._aiSetting.concat(e.Content)
							}
							o()
						}
					}, s = function(e) {
			...
			return this._aiContainer.addChild(t), t
		}, a.prototype.dispose = function() {
			this.cancel(), this._aiRects = [], this._aiSetting = [], this._player = null
		}, t.exports = a
	}, {
		"../../lib/io": 30,
	...
	91: [function(e, t, i) {
		var n = e("../base/event/eventtype"),
			r = function(i) {
				...
				var r = this;
				this._isCreated = !1, this._canPlayTriggered = !1, this._defaultTrack = "", i.on(n.Private.ChangeURL, function() {
					r._isCreated = !1, r._canPlayTriggered = !1, r._defaultTrack = ""
				}), i.on(n.Player.CanPlay, function() {
					if(!r._player._drm && !r._canPlayTriggered) {
						var e = r._getTracks();
						e && (r._isCreated = !0, i.trigger(n.Player.AudioTrackReady, e), r._notifyDefaultValue(e)), r._canPlayTriggered = !0
					}
		...
		a.prototype._adaptiveCueStype = function() {
			...
			for(var t = [this._defaultTrack], i = l.get(c.SelectedCC), r = "", n = !1, o = 0; o < e; o++) {
				...
				if("expired" != a.mode && "subtitles" == a.kind) {
					...
					a["default"] && (this._defaultTrack = s, n = !0), s.value == i && (r = s), t.push(s)
				}
			}
		...
		u.prototype.requestFullScreen = function() {
			if(!r.isAndroidX5() || !this._player.paused()) {
				var e = c,
					t = this._player.el(),
					i = this;
				if(n.IS_IOS) return(t = this._player.tag)[e.requestFn](), i._player.trigger(s.Player.RequestFullScreen), this;
	...
	95: [function(e, t, i) {
		...
		h.prototype.validate = function() {
			...
			if(a.isHls(i)) e = i;
				...
				return this._player._options._autoplay = !0, l.inject(this._player, n, r, this._player._options, function() {}, !0), t
			}
			return e
			...
			if(a.isFlv(e)) {
				...
				this._player._options._autoplay = !0, r.inject(this._player, i, t.prototype, this._player._options, function() {}, !0)
			}
			return e
			...
			if(this._player.trigger(u.Private.LiveShiftQueryCompleted), this._liveShiftUrl) {
				...
				this.queryLiveShift(this._liveShiftUrl, function(e) {
					if(e) {
						var t = e;
						0 == t.retCode ? (p(n, t.content.current), i && i()) : r({
							Code: c.ErrorCode.ServerAPIError,
							Message: t.retCode + "|" + t.description + "|" + t.content
						})
					} else console.log("鑾峰彇鐩存挱鏃剁Щ鏁版嵁澶辫触")
				}, function(e) {
					if(r && e) {
						var t = {};
						if(e) {
							if(-1 < e.indexOf("403 Forbidden")) t.Code = c.ErrorCode.AuthKeyExpired, t.Message = "Query liveshift failed:" + s.get("Error_AuthKey_Text");
							else {
								var i;
								t = e;
								try {
			...
			var e = this,
				t = function() {
					e._localLiveTimeHandler = setTimeout(function() {
						e.currentTimestamp++, p(e, e.currentTimestamp), e._player.trigger(u.Private.LiveShiftQueryCompleted), t()
					}, 1e3)
				};
			t()
		}, h.prototype.setLiveTimeRange = function(e, t) {
			e || (e = this._player._options.liveStartTime), t || (t = this._player._options.liveOverTime), this.liveTimeRange = d(e, t), p(this, this.currentTimestamp), this._player.trigger(u.Private.LiveShiftQueryCompleted)
		...
		n.prototype.loadVideoInfo = function(i) {
			...
			r.jsonp("//tv.taobao.com/player/json/getBaseVideoInfo.do?vid=" + n + "&playerType=3", function(e) {
				...
				_.each(e.data.source, function(e, t) {
					var i = +e.substring(1);
					r < i && (r = i)
				}), t = e.data.source["v" + r], t = _.unescape(t), o._options.source = t, s.inject(o, TaobaoTVPlayer, a.prototype, o._options), o.initPlay(), i && i()
			}, function() {
	...
	99: [function(e, t, i) {
		var r = e("../lib/oo"),
			...
			p = r.extend({
				init: function(e, t) {
					...
					var r = e.id;
					"function" == typeof e.id && (r = e.id()), this._id = r + "_component_" + n.guid(), this._children = [], this._childIndex = {}, this._player.on(u.Private.UiH5Ready, function() {
		...
		p.prototype.renderUI = function() {
			...
			if(e = (i = this).options().children)
				if(a.isArray(e))
					for(var o = 0; o < e.length; o++) "string" == typeof(t = e[o]) ? (r = t, n = {}) : (r = t.name, n = t), i.addChild(r, n);
	...
	100: [function(e, t, i) {
		var r = e("../../component"),
			...
			o = r.extend({
				init: function(e, t) {
					r.call(this, e, t), this.addClass("prism-ai-container"), this.width = 0, this.height = 0
				},
				createEl: function() {
					var e = r.prototype.createEl.call(this);
					return this.bindEvent(), e
				},
				bindEvent: function() {
					var e = this;
				...
				computeLayout: function(e) {
					if(this._player.tag)
						if(e = e || this.el(), videoTag = this._player.tag, playerEle = this._player.el(), videoW = videoTag.videoWidth, videoH = videoTag.videoHeight, eleWidth = playerEle.offsetWidth, eleHeight = playerEle.offsetHeight, tagW = videoTag.offsetWidth, tagH = videoTag.offsetHeight, width = eleWidth > tagW ? tagW : eleWidth, height = eleHeight > tagH ? tagH : eleHeight, height / width < videoH / videoW) {
							...
							e.style.width = t + "px", height < eleHeight ? (e.style.top = (eleHeight - height) / 2 + "px", e.style.height = height + "px", this.height = height) : (e.style.top = "0px", e.style.height = "100%", this.height = eleHeight), e.style.left = (width - t) / 2 + "px", this.width = t
						} else {
							var i = videoH / videoW * width;
							e.style.height = i + "px", width < eleWidth ? (e.left = (eleWidth - width) / 2 + "px", e.style.width = width + "px", this.width = width) : (e.style.width = "100%", e.style.left = "0px", this.width = eleWidth), e.style.top = (height - i) / 2 + "px", this.height = i
						}
				},
				reLayout: function() {
					this.computeLayout();
					for(var e = this._children.length, t = 0; t < e; t++) this._children[t].reset()
				},
				getWidth: function() {
					return this.width
				},
	...
	101: [function(e, t, i) {
		var r = e("../../component"),
			...
			n = (e("../../../lib/event"), r.extend({
				init: function(e, t) {
					r.call(this, e, t), this.addClass("prism-ai-marking"), this._width = 0, this._height = 0, this._tid = ""
				},
				createEl: function() {
					var e = r.prototype.createEl.call(this),
				...
				updateAnchor: function(e) {
					...
					t.style["border-width"] = e + "px", (t = document.querySelector("#" + this.id() + " .top-right-anchor")).style["border-width"] = e + "px"
				},
				...
				updateLabels: function(e) {
					if(!e || 0 != e.length) {
						...
						return document.querySelector("#" + this.id() + " .prism-ai-labels").innerHTML = t.text, t.title
					}
				},
				getTid: function() {
					return this._tid
				...
				bindEvent: function() {
					...
					o.on(this.el(), "mouseover", function() {
						...
						if(t._player.paused()) {
							...
							t._player.getDuration() <= e && t._player.seek(0), t._player.play(!0)
						} else t._player.pause()
			...
			n = r.extend({
				...
				onEvent: function() {
					...
					if(1 == e.controlBarForOver && (r = "hover"), "hover" == r) {
						i.hide();
						var n = function() {
							i._hideHandler && clearTimeout(i._hideHandler), i._show(), t.fullscreenService.getIsFullScreen() && i._hide()
						};
						t.on(o.Private.MouseOver, function() {
							...
							i._hideHandler = setTimeout(function() {
								i.hide(), t.trigger(o.Private.HideBar), t.trigger(o.Private.VolumeVisibilityChange, ""), t.trigger(o.Private.SettingListHide)
							})
						})
		...
		var r = e("../component"),
			...
			a = r.extend({
				...
				createEl: function() {
					...
					return t && (e.style.backgroundImage = "url(" + t + ")"), e
				},
				_hide: function(e) {
	...
	106: [function(e, t, i) {
		var r = e("../component"),
			...
			s = r.extend({
				...
				createEl: function() {
					var e = r.prototype.createEl.call(this, "div");
					return e.innerHTML = "<div class='prism-error-content'><p></p></div><div class='prism-error-operation'><a class='prism-button prism-button-refresh'>" + v.get("Refresh_Text") + "</a><a class='prism-button prism-button-retry'  target='_blank'>" + v.get("Retry") + "</a><a class='prism-button prism-button-orange'  target='_blank'>" + v.get("Detection_Text") + "</a></div><div class='prism-detect-info prism-center'><p class='errorCode'><span class='info-label'>code锛�</span><span class='info-content'></span></p><p class='vid'><span class='info-label'>vid:</span><span class='info-content'></span></p><p class='uuid'><span class='info-label'>uuid:</span><span class='info-content'></span></p><p class='requestId'><span class='info-label'>requestId:</span><span class='info-content'></span></p><p class='dateTime'><span class='info-label'>" + v.get("Play_DateTime") + "锛�</span><span class='info-content'></span></p></div>", e
				},
				bindEvent: function() {
					var i = this;
			...
			a = r.extend({
				...
				bindEvent: function() {
					...
					this._player.on(n.Player.Play, function() {
						t.removeClass("prism-pause-animation"), t.addClass("prism-play-animation"), t.removeClass("play-apply-animation"), t.playHandler && clearTimeout(t.playHandler), t.playHandler = setTimeout(function() {
							t.addClass("play-apply-animation")
						})
					}), this._player.on(n.Player.Pause, function() {
						var e = t._player._status;
						e != o.ended && e != o.error && (t.removeClass("prism-play-animation"), t.addClass("prism-pause-animation"), t.removeClass("play-apply-animation"), t.pauseHandler && clearTimeout(t.pauseHandler), t.pauseHandler = setTimeout(function() {
							t.addClass("play-apply-animation")
						}))
					})
				},
			...
			s = r.extend({
				...
				bindEvent: function() {
					...
					this._player.on(n.Player.Play, function() {
						...
						if(t._player.paused()) {
							var e = t._player.getCurrentTime();
							t._player.getDuration() <= e && t._player.seek(0), t._player.play(!0), t.addClass("playing")
						} else t._player.pause(), t.removeClass("playing")
					}), o.registerTooltipEvent.call(this, this.el(), function() {
	...
	113: [function(e, t, i) {
		var r = e("../component"),
			...
			p = r.extend({
				...
				createEl: function() {
					var e = r.prototype.createEl.call(this);
					return e.innerHTML = '<div class="prism-progress-loaded"></div><div class="prism-progress-played"></div><div class="prism-progress-cursor"><img></img></div><p class="prism-progress-time"></p>', e
				},
				bindEvent: function() {
					var t = this;
					this.loadedNode = document.querySelector("#" + this.id() + " .prism-progress-loaded"), this.playedNode = document.querySelector("#" + this.id() + " .prism-progress-played"), this.cursorNode = document.querySelector("#" + this.id() + " .prism-progress-cursor"), this.timeNode = document.querySelector("#" + this.id() + " .prism-progress-time"), this.controlNode = document.querySelector("#" + this._player._options.id + " .prism-controlbar");
					var e = document.querySelector("#" + this.id()),
					...
					c.domain ? -1 < c.domain.indexOf("localhost") && (r = "//" + c.domain + "/build/skins/default/img/dragcursor.png") : r = "de/prismplayer/" + c.h5Version + "/skins/default/img/dragcursor.png", i.src = r, n.on(this.cursorNode, "mousedown", function(e) {
						t._onMouseDown(e)
					}), n.on(this.cursorNode, "touchstart", function(e) {
						t._onMouseDown(e)
						...
						t._offMouseUp()
					}), this.bindTimeupdate = s.bind(this, this._onTimeupdate), this._player.on(d.Player.TimeUpdate, this.bindTimeupdate), o.IS_IPAD ? this.interval = setInterval(function() {
						t._onProgress()
					}, 500) : this._player.on(d.Video.Progress, function() {
						t._onProgress()
					})
				...
				_onMouseOver: function(e) {
					if(this._cursorHideHandler && (clearTimeout(this._cursorHideHandler), this._cursorHideHandler = null), !this._mouseInProgress) {
						...
						var t = this;
						t.cursorNodeHandler && clearTimeout(t.cursorNodeHandler), t.cursorNodeHandler = setTimeout(function() {
				...
				_onMouseOut: function(e) {
					...
					this._cursorHideHandler && clearTimeout(this._cursorHideHandler), this._cursorHideHandler = setTimeout(function() {
						t.cursorNode && (a.css(t.cursorNode, "display", "none"), t._player.trigger(d.Private.ThumbnailHide), t._mouseInProgress = !1)
					})
				},
				_getSeconds: function(e) {
				...
				_onMouseClick: function(e) {
					...
					if(this._canSeekable(t)) {
						...
						}), this._updateCursorPosition(t), this._player.seek(t);
						this._player.trigger(d.Private.EndStart, {
							toTime: t
						})
					} else this._player.trigger(d.Private.Info_Show, {
				...
				_onMouseMove: function(e) {
					e.preventDefault();
					var t = this._getSeconds(e);
					this._player._hls || (this._player.seek(t), this._player.play()), this._updateProgressBar(this.playedNode, t), this._updateCursorPosition(t)
				},
				_onTimeupdate: function(e) {
					this._updateProgressBar(this.playedNode, this._player.getCurrentTime()), this._updateCursorPosition(this._player.getCurrentTime()), this._player.trigger(d.Private.UpdateProgressBar, {
				...
				_updateCursorPosition: function(e) {
					...
					if(1 != this._player._switchSourcing && t) {
						var i = 1,
							...
							n = 18 / r,
							o = e / t - n;
						0 != r && (i = 1 - n), this.cursorNode && (i < o ? (a.css(this.cursorNode, "right", "0px"), a.css(this.cursorNode, "left", "auto")) : (a.css(this.cursorNode, "right", "auto"), a.css(this.cursorNode, "left", 100 * o + "%")))
					}
				},
				disposeUI: function() {
					this.cursorNodeHandler && (clearTimeout(this.cursorNodeHandler), this.cursorNodeHandler = null), this._cursorHideHandler && (clearTimeout(this._cursorHideHandler), this._cursorHideHandler = null)
				}
			});
		t.exports = p
	}, {
	...
	114: [function(e, t, i) {
		var r = e("./selector"),
			s = e("../../../lib/object"),
			l = (e("../../../lib/util"), e("../../../lib/cookie")),
			c = e("../../../lib/dom"),
			u = (e("../../../lib/event"), e("../../../lib/constants")),
			d = e("../../../lang/index"),
			...
			n = r.extend({
					...
					this._player.on(p.Private.QualityChange, function(e) {
						...
						if(i.levelSwitch) {
							...
							var n = s._player._currentPlayIndex,
								o = t[n - 1].desc,
								a = t[n].desc;
							s.showTip(o + e.paramData + a, 1e3), s._player.trigger(p.Private.SelectorValueChange, t[n].Url)
						}
					});
					...
					if(0 < t.length) {
						...
						s.each(t, function(e, t) {
							if(e.desc) {
								...
								t == n && (c.addClass(i, "current"), a._previousSelection = i), r.innerText = e.desc, i.appendChild(r), o.appendChild(i)
							}
						})
					}
				...
				execute: function(e) {
					if(this._player._switchSourcing = !0, this._isMasterLevel) {
						...
						for(o = 0; o < t.length; o++) t[o].Url == e && t[o].desc != d.get("Auto") && this._updateText("");
						...
						for(var i = this._player._urls.length, r = this._player._currentPlayIndex, n = -1, o = 0; o < i; o++)
							if(this._player._urls[o].Url == e) {
								n = this._player._currentPlayIndex = o, l.set(u.SelectedStreamLevel, this._player._urls[o].definition, 365);
								break
							}
	...
	115: [function(e, t, i) {
		var r = e("./selector"),
			...
			o = r.extend({
				init: function(e, t) {
					this.Name = n.get("AudioTrack"), this.Type = "audio", this.Tooltip = n.get("AudioTrack_Switch_To"), r.call(this, e, t)
				},
				bindEvent: function() {
					this.bindCommonEvent();
					var n = this,
					...
					n._player.on(l.Private.ChangeURL, function() {
						...
						n._hasGeneratedList || (n._clear(), (e = e.paramData) && (a.each(e, function(e, t) {
							...
							r.innerText = e.text, i.appendChild(r), o.appendChild(i)
	...
	116: [function(e, t, i) {
		var r = e("../../component"),
			...
			l = r.extend({
				init: function(e, t) {
					r.call(this, e, t), this.addClass(t.className || "prism-setting-btn"), this._settingList = new o(e, t), e.addChild(this._settingList, t)
				},
				createEl: function() {
					return r.prototype.createEl.call(this, "div")
				},
				bindEvent: function() {
					var e = this;
					this.on("click", function() {
						e._settingList.isOpened ? e._player.trigger(n.Private.SettingListHide) : e._player.trigger(n.Private.SettingListShow), e._player.trigger(n.Private.SelectorHide), e._player.trigger(n.Private.VolumeVisibilityChange, "")
			...
			u = r.extend({
				...
				bindEvent: function() {
					...
					this._player.on(c.Private.CCStateChanged, function(e) {
						...
						var r = "Off";
						"on" == t && (r = n._backCCText), n._player.trigger(c.Private.SelectorUpdateList, {
							type: "cc",
							text: r
						})
					})
				...
				generateList: function(n) {
					...
					s.each(e, function(e, t) {
						...
						e.text == n && (l.addClass(i, "current"), a._previousSelection = i), r.innerText = e.text, i.appendChild(r), o.appendChild(i)
					})
				},
				execute: function(e) {
					this._backCCText = "", n.set(o.SelectedCC, e, 365), this._player._ccService["switch"](e), this._player.trigger(c.Private.CCChanged, e)
				}
			});
		t.exports = u
	}, {
			...
			o = r.extend({
				...
				bindCommonEvent: function() {
					...
					this._player.on(c.Private.ChangeURL, function() {
						...
						o._player.trigger(c.Private.SelectorHide), o._player.trigger(c.Private.SettingListShow, {
							type: o.Type,
						...
						var t = e.srcElement ? e.srcElement : e.target,
							...
							r = t.text;
						if(void 0 !== r) {
							o._previousSelection && a.removeClass(o._previousSelection, "current"), o._previousSelection = l.findliElementForSelector(t), a.addClass(o._previousSelection, "current"), o.execute && o.execute(i);
						...
						if(t) {
							...
							if(i) {
								...
								for(var n = 0; n < r; n++)
									if(i[n].text == t.text) {
										o._previousSelection && a.removeClass(o._previousSelection, "current"), a.addClass(i[n], "current"), o._previousSelection = i[n];
										break
									}
							}
						}
						...
						if((e = e.paramData).type == o.Type) {
							...
							o._hasGeneratedList || (o._clear(), o.generateList(o._backupSelector), o._backupSelector = "", o._hasGeneratedList = !0), a.css(t, "display", "block")
						}
					});
					var i = function() {
							a.css(o.el(), "display", "none"), o._player.trigger(c.Private.UpdateToSettingList, {
								type: o.Type,
								text: o._previousSelection ? o._previousSelection.text : ""
							})
						},
	...
	121: [function(e, t, i) {
		var r = e("./selector"),
			...
			n = (e("../../../player/base/event/eventtype"), r.extend({
				init: function(e, t) {
					this.Name = c.get("Speed"), this.Type = "speed", this.Tooltip = c.get("Speed_Switch_To"), r.call(this, e, t)
				},
				generateList: function() {
					...
					a.each(e, function(e, t) {
						...
						r.innerText = e.text, e.text == c.get("Speed_1X_Text") && (s.addClass(i, "current"), o._previousSelection = i), i.appendChild(r), n.appendChild(i)
					})
				},
				execute: function(e) {
			...
			s = r.extend({
				...
				bindEvent: function() {
					...
					this._player.on(v.Private.Snapshot_Hide, function() {
						...
						"vertical" == s ? (a.translate(0, e.height), a.scale(1, -1)) : "horizon" == s && (a.translate(e.width, 0), a.scale(-1, 1)), a.drawImage(t, 0, 0, i, r), a.restore(), y(a, h._player.getOptions());
						var l = "",
							c = "";
						try {
						...
						var u = "",
							d = "",
							p = "";
						l && (d = (u = l).substr(u.indexOf(",") + 1), p = f.toBinary(d)), h.trigger(v.Player.Snapshoted, {
							time: o,
							base64: u,
							binary: p,
							error: c
				...
				bindEvent: function() {
					...
					c._player.on(n.Private.ThumbnailLoaded, function(e) {
						...
						if(t && 0 < t.length) {
							...
							if(t[0].isBig) u.css(c.el(), "background", "url(" + i + ")"), u.css(c.el(), "width", t[0].w + "px"), u.css(c.el(), "height", t[0].h + "px");
							else {
								var r = document.querySelector("#" + c.id() + " img");
								r.onload = function() {
									var e = r.width,
										t = r.height;
									u.css(c.el(), "width", e + "px"), u.css(c.el(), "height", t + "px")
								}, r.src = i
							}
						}
					}), c._player.on(n.Private.ThumbnailShow, function(l) {
						c._thumbnailShowHanlde && clearTimeout(c._thumbnailShowHanlde), c._thumbnailShowHanlde = setTimeout(function() {
							...
							if(t) {
								...
								if(i.isBig) {
									...
									u.css(c.el(), "background", "url(" + n + ")"), i.w, i.h;
									var o = -1 * i.x + "px " + -1 * i.y + "px";
									u.css(c.el(), "background-position", o)
								} else {
									var a = document.querySelector("#" + c.id() + " img");
									n = c._player._thumbnailService.makeUrl(i.text), a.src != n && (a.src = n)
								}
								var s = 0;
								s = t.left + r > t.progressWidth ? t.left - r : (s = t.left - r / 2) < 0 ? 0 : s, u.css(c.el(), "left", s + "px"), e.innerText = t.formatTime, u.css(c.el(), "display", "block")
							}
						}, 30)
					}), c._player.on(n.Private.ThumbnailHide, function(e) {
						c._thumbnailShowHanlde && clearTimeout(c._thumbnailShowHanlde), u.css(c.el(), "display", "none")
					})
				},
	...
	127: [function(e, t, i) {
		...
		t.exports.registerTooltipEvent = function(e, n) {
			...
			r.on(this.el(), "mouseover", function(e) {
				a(), o._controlbarTooltipHandler = setTimeout(function() {
					o._player.trigger(s.Private.TooltipHide)
				}, 4e3);
				var t = o.el().offsetLeft,
					i = o.el().offsetWidth,
					r = n;
				"function" == typeof r && (r = n.call(this)), o._player.trigger(s.Private.TooltipShow, {
					left: t,
					width: i,
					text: r
				})
			}), r.on(this.el(), "mouseout", function() {
				a(), o._player.trigger(s.Private.TooltipHide)
			})
		}
	}, {
		"../../lib/event": 25,
			...
			u = r.extend({
				...
				bindEvent: function() {
					...
					this.icon = document.querySelector("#" + i.id() + "  .volume-icon"), s.registerTooltipEvent.call(this, this.el(), function() {
						...
						i._player.trigger(a.Private.SettingListHide), i._player.trigger(a.Private.SelectorHide), i._player.trigger(a.Private.VolumeVisibilityChange, t)
					});
				...
				bindEvent: function() {
					...
					this.icon = document.querySelector("#" + r._player.id() + "  .volume-icon"), this.control = document.querySelector("#" + r.id()), this.volumnValue = document.querySelector("#" + r.id() + "  .volume-value"), this.volumnRange = document.querySelector("#" + r.id() + "  .volume-range"), this.volumnCursor = document.querySelector("#" + r.id() + "  .volume-cursor"), this._player.on(a.Private.VolumeVisibilityChange, function(e) {
						...
						if(!r._shown && t) {
							...
							r._setVolumnUI(i), n.css(r.control, "display", "block"), t && n.css(r.control, "left", t - 5 + "px"), r._shown = !0
						} else n.css(r.control, "display", "none"), r._shown = !1
					}), o.on(this.volumnRange, "click", function(e) {
						var t = r._getPosition(e).toFixed(2);
						t < 0 && (t = 0), 1 < t && (t = 1), r._setVolumnUI(t), r._setMuteUI(t), r._player.setVolume(t)
