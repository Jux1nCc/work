  ...
  mounted: function (data, type) {
    ...
    if (data.sex == 1) {
      ...
      if (type == 1) {
        ...
        if (!data.gainAmt || !data.payCustomerId) {
          $('.contain-4').addClass('popup')
        }
      } else {
...
window.onload = function () {
  setTimeout(function () {
    // preload image  
    var ImgArr = ['contain_boy1', 'contain_girl1', 'arrow_1', 'arrow_2', 'contain1_girl', 'contain2_girl', 'contain3_girl', 'contain4_girl', 'contain5_girl', 'contain6_girl', 'contain7_girl', 'keyword', 'white_bg', 'share']
