    ...
    if (ua.indexOf(" MicroMessenger/") > -1) {
       ...
       /* $('#alertbg').css('display', 'block');
        ...
        if (ua.indexOf("Android") > -1) {
            ...
            setTimeout(function(){
                if (Date.now() - t < 1200) {
                    location.href = 'http://a.app.qq.com/o/simple.jsp?pkgname=com.rablive.jwrablive';
                }
            }, 1000);
...
function downClient(){
    ...
    if (ua.indexOf(" MicroMessenger/") > -1) {
        ...
        if (ua.indexOf("Android") > -1) {
            //直接下载apk
            window.location="http://a.app.qq.com/o/simple.jsp?pkgname=com.rablive.jwrablive";
        } else if (ua.indexOf("iPhone") > -1 || ua.indexOf("iPad") > -1 || ua.indexOf("iPod") > -1) {
            //直接进入appstore
